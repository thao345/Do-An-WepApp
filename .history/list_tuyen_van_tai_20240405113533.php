                ...
                <div class="modal-dialog modal-lg modal-dialog-centered  modal-dialog-scrollable">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form class="needs-validation" novalidate action="them_tuyen_van_tai.php" method="POST">
                                <div class="form-row">
                    ...
                    <table class=" table table-striped table-bordered table-hover " id="myTable" width="100%"
                        ...
                        <thead style=" white-space: nowrap;">
                            <tr>
                                ...
                                <th>Tên tuyến</th>
                                <th>Điểm đầu</th>
                                <th>Mã tỉnh thành đầu</th>
                                <th>Điểm cuối</th>
                                <th>Mã tỉnh thành cuối</th>
                                <th>Cự ly (km)</th>
                                <th>Ngày tạo</th>
                                <th>Người tạo</th>
                                <th>Ngày sửa</th>
                        ...
                        <tbody style=" white-space: nowrap;">
                            ...
                            foreach ($result as $items):
                                ...
                                <tr data-id="<?php echo $items['id_tuyenvantai']; ?>">
                                    ...
                                    <td>
                                        <?php echo $items['id_tinhthanhdau']; ?>
                                    </td>
                                    <td>
                                        <?php echo $items['diemcuoi']; ?>
                                    </td>
                                    <td>
                                        <?php echo $items['id_tinhthanhcuoi']; ?>
                                    </td>
                                    <td>
                                        <?php echo $items['culy']; ?>
                                    </td>
                                    ...
                                    <td>
                                        <form action="sua_tuyen_van_tai.php" method="POST">
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <form action="them_tuyen_van_tai.php" method="POST">
