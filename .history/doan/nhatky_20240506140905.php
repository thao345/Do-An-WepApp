...
$sqlBase = "SELECT tinhthanh.id_tinhthanh, tinhthanh.ten, nguoidung.tendangnhap AS nguoitao, nguoidung.id_nguoidung, DATE(tinhthanh.ngaytao) as ngaytao, nguoidung2.tendangnhap AS nguoisua, nguoidung2.id_nguoidung, DATE(tinhthanh.ngaysua) as ngaysua
FROM tinhthanh
                                ...
                                <tr data-id="<?php echo $items['id_tinhthanh']; ?>">
                                    ...
                                    <td>
                                        ...
                                        <button class="btn btn-danger" data-toggle="modal"
                                            data-target="#deleteModal-<?php echo $items['id_tinhthanh']; ?>">Xoá</button>
                                    </td>
                                </tr>
