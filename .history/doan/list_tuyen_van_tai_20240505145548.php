...
if (isset($_GET['filter']))
    if (isset($_GET['from_date']) && isset($_GET['to_date'])) {
        ...
        $table = "tuyenvantai";
        $columns = array("$table.id_$table", "$table.ten", "$table.diemdau", "$table.id_tinhthanhdau", "$table.diemcuoi", "$table.id_tinhthanhcuoi", "$table.culy", "$table.cmnd", "$table.sđt", "$table.stk", "$table.tennganhang");
