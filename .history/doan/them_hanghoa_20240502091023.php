...
if (isset($_POST['thembtn'])) {
    if (
        ...
        $sql = "INSERT INTO `hanghoa`( `id_hanghoa`, `ten`,`id_nhomhanghoa`, `kichthuoc`, `cmnd`, 
        `sobanglai`, `id_thauphu`, `ngaytao`, `id_nguoitao`) 
        VALUES ('$id_hanghoa', '$ten','$id_nhomhanghoa','$kichthuoc','$cmnd','$sobanglai','$id_thauphu', current_timestamp(),'5')";
