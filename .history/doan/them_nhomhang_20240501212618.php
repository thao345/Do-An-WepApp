...
if (isset($_POST['thembtn'])) {
    if (isset($_POST['id_nhomhanghoa']) && isset($_POST['ten'])) {
        ...
        $ten = $_POST['ten'];
        $sql = "INSERT INTO tinhthanh (id_nhomhanghoa, ten, id_nguoitao, ngaytao) VALUES ('$idtt', '$ten', '2', current_timestamp())";
...
if (isset($_POST['xoabtn'])) {
    ...
    $sql = "DELETE FROM `tinhthanh` WHERE id_nhomhanghoa = '$idtt'";
    $stmt = $conn->prepare($sql);
    $query = $stmt->execute();
