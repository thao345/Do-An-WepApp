...
$sql = "SELECT thauphu.id_thauphu, thauphu.ten, thauphu.diachi, thauphu.sodienthoai, thauphu.donvitinh, thauphu.ghichu, nguoidung.tendangnhap AS nguoitao, nguoidung.id_nguoidung, DATE(thauphu.ngaytao) as ngaytao, nguoidung2.tendangnhap AS nguoisua, nguoidung2.id_nguoidung, DATE(thauphu.ngaysua) as ngaysua
        FROM thauphu
