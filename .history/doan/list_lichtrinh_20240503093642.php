...
$sqlCount = "SELECT COUNT(*) as total_rows FROM lic";
...
$sql = "SELECT lic.id_lic, lic.ten, lic.diachi, lic.sodienthoai, lic.masothue, nhomhanghoa.ten as tennhomhanghoa, nguoidung.tendangnhap AS nguoitao, nguoidung.id_nguoidung, DATE(lic.ngaytao) as ngaytao, nguoidung2.tendangnhap AS nguoisua, nguoidung2.id_nguoidung, DATE(lic.ngaysua) as ngaysua
        FROM lic
        INNER JOIN nhomhanghoa ON lic.id_nhomhanghoa = nhomhanghoa.id_nhomhanghoa
        INNER JOIN nguoidung ON lic.id_nguoitao = nguoidung.id_nguoidung
        LEFT JOIN nguoidung AS nguoidung2 ON lic.id_nguoisua = nguoidung2.id_nguoidung
        WHERE 1
        ORDER BY lic.ngaytao DESC
...
if (isset($_GET['from_date']) && isset($_GET['to_date'])) {
    ...
    $sql = "SELECT lic.id_lic, lic.ten, lic.diachi, lic.sodienthoai, lic.masothue, nhomhanghoa.ten as tennhomhanghoa, nguoidung.tendangnhap AS nguoitao, nguoidung.id_nguoidung, DATE(lic.ngaytao) as ngaytao, nguoidung2.tendangnhap AS nguoisua, nguoidung2.id_nguoidung, DATE(lic.ngaysua) as ngaysua
            FROM lic
            INNER JOIN nhomlic ON lic.id_nhomlic = nhomlic.id_nhomlic
            INNER JOIN nguoidung ON lic.id_nguoitao = nguoidung.id_nguoidung
            LEFT JOIN nguoidung AS nguoidung2 ON lic.id_nguoisua = nguoidung2.id_nguoidung
            WHERE lic.ngaysua BETWEEN '$from_date' AND '$to_date'
            ORDER BY lic.ngaytao DESC
            LIMIT $offset,$total_records_per_page";
...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <div class="d-flex">
                ...
                <form class="form-inline ml-auto mr-4 border p-3 rounded filterlic" method="GET">
                ...
                <div class="modal-dialog modal-lg modal-dialog-centered  modal-dialog-scrollable">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form class="needs-validation" novalidate action="them_lic.php" method="POST">
                                <div class="form-row">
                                    <div class="col-md-4 mb-3">
                                        <label for="validationCustom01">Mã thầu phụ</label>
                                        <input type="text" class="form-control" name="id_lic"
                    ...
                    <table class=" table table-bordered table-hover " id="myTable" width="100%" cellspacing="0">
                        ...
                        <tbody style=" white-space: nowrap;">
                            ...
                            foreach ($result as $items):
                                ...
                                <tr data-id="<?php echo $items['id_lic']; ?>">
                                    <td>
                                        <?php echo $count++; ?>
                                    </td>
                                    <td>
                                        <?php echo $items['id_lic']; ?>
                                    </td>
                                    <td>
                                        <?php echo $items['ten']; ?>
                                    </td>
                                    ...
                                    <td>
                                        <form action="sua_lic.php" method="POST">
                                            <input type="hidden" name="edit_id"
                                                value="<?php echo $items['id_lic']; ?>">
                                            <button name="suabtn" class="btn btn-success">Sửa</button>
                                        </form>
                                    </td>
                                    <td>
                                        <!-- Thêm modal dialog -->
                                        <div class="modal" id="deleteModal-<?php echo $items['id_lic']; ?>" tabindex="-1" role="dialog">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <form action="them_lic.php" method="POST">
                                        ...
                                        <button class="btn btn-danger" data-toggle="modal"
                                            data-target="#deleteModal-<?php echo $items['id_lic']; ?>">Xoá</button>
                                    </td>
                                </tr>
    ...
    <script>
        ...
        $('tr[data-id]').on('dblclick', function () {
            ...
            window.location.href = 'sua_lic.php?edit_id=' + id;
        });
