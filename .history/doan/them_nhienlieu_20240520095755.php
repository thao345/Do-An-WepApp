...
if (isset($_POST['thembtn'])) {
    ...
    isset($_POST['ngayapdung'])
        ...
        $ten = $_POST['ten'];$ten = $_POST['ten'];$ten = $_POST['ten'];
        $sql = "INSERT INTO nhienlieu (id_nhienlieu, ten, id_nguoitao, ngaytao) VALUES ('$idtt', '$ten', '$id_nguoidung', current_timestamp())";
