                ...
                <div class="modal-dialog modal-xl modal-dialog-centered  modal-dialog-scrollable">
                    <div class="modal-content">
                        ...
                        <div class="modal-body ">
                            <form class="needs-validation" action="them_donhang.php" method="POST"
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <input type="date" class="form-control" name="ngaydongcontainer"
                                            id="validationCustom02" placeholder="Chọn ngày đóng container" value=""
                                            required>
                                        <div class="invalid-feedback">
                                            Ngày đóng container.
                                        </div>
                                ...
                                if ($stmt->rowCount() > 0) {
                                    ...
                                    <td>
                                        <form action="sua_dieuhanh.php" method="POST">
                                            ...
                                            <button name="suabtn" class="btn btn-dieuhanh  btn-block" <?php echo $disableXoa; ?>
                                                <?php echo $disableHuy; ?>>Sửa điều hành</button>
                                        </form>
                                    </td>
                                    <?php
                                } else {
                                    ...
                                    ?>
                                    <td>
                                        <button type="button" class="btn btn-dieuhanh  dieuhanh btn-block" data-toggle="modal"
                                            data-target="#modalDieuHanh" data-whatever="@mdo"
                                            data-id-donhang="<?php echo $items['id_donhang']; ?>" <?php echo $disableXoa; ?>
                                            <?php echo $disableHuy; ?>>Thêm điều hành</button>
                                    </td>
                                    <?php
                                }
                                ...
                                if ($stmt->rowCount() > 0) {
                                    ...
                                    <td>
                                        <form action="sua_tamung.php" method="POST">
                                            ...
                                            <input type="hidden" name="edit_id_donhang"
                                                value="<?php echo $items['id_donhang']; ?>">
                                            <button name="suabtn" class="btn btn-info btn-block" <?php echo $disableXoa; ?>
                                                <?php echo $disableHuy; ?>>Sửa tạm
                                                ứng</button>
                                        </form>
                                    </td>
                                    <?php
                                    ...
                                    ?>
                                    <td>
                                        <button type="button" class="btn btn-info tamung btn-block" data-toggle="modal"
                                            data-target="#modalTamUng" data-whatever="@mdo"
                                            data-id-donhang="<?php echo $items['id_donhang']; ?>" <?php echo $disableXoa; ?>
                                            <?php echo $disableHuy; ?>>Thêm tạm
                                            ứng</button>
                                    </td>
                                    <?php
                                }
    ...
    <div class="modal fade" id="modalTamUng" tabindex="-1" aria-labelledby="modalTamUngLabel" aria-hidden="true">
        ...
        <div class="modal-dialog modal-xl modal-dialog-centered  modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="needs-validation" action="them_tamung.php" method="POST" enctype="multipart/form-data">
                        <div class="form-row">
                            <div class="col-sm-12">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-3 mb-3">
                                                ...
                                                <input type="text" class="form-control" name="id_donhang_tamung"
                                                    id="id_donhang_tamung" placeholder="mã đơn hàng" value="" readonly>
                                            </div>
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-3 mb-3">
                                                ...
                                                <input type="date" class="form-control" name="ngaytamung"
                                                    id="ngaytamung" placeholder="Chọn ngày tạm ứng" value="" required>
                                                <div class="invalid-feedback">
                                                    Ngày tạm ứng.
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-3 mb-3">
                                                ...
                                                <input type="text" class="form-control" name="tiennangha_tamung"
                                                    id="tiennangha_tamung" placeholder="Nhập tiền nâng hạ..." value="">
                                            </div>

                                            <div class="col-md-3 mb-3">
                                                <label for="tienkhac_tamung">Tiền khác :</label>
                                                <input type="text" class="form-control" name="tienkhac_tamung"
                                                    id="tienkhac_tamung" placeholder="Nhập tiền khác..." value="">
                                            </div>
    ...
    <div class="modal fade" id="modalDieuHanh" tabindex="-1" aria-labelledby="modalDieuHanhLabel" aria-hidden="true">
        ...
        <div class="modal-dialog modal-xl modal-dialog-centered  modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="needs-validation" action="them_dieuhanh.php" method="POST"
                        enctype="multipart/form-data">
                        <div class="form-row">
                            <div class="col-sm-12">
                                <div class="card text-white bg-secondary mb-3">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="text" class="form-control" name="tenthauphu_dh"
                                                    id="tenthauphu_dh" placeholder="Tên chủ xe..." value="" readonly>
                                            </div>
                                            ...
                                            <div class="col-md-3 mb-3">
                                                ...
                                                <input type="number" class="form-control" name="sodonkethop_dh"
                                                    id="sodonkethop_dh" placeholder="Nhập số đơn" value="0" disabled>
                                            </div>
                                            <script>
