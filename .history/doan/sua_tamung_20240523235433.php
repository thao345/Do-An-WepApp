...
if (isset($_POST['suabtn'])) {
    ...
    // data ĐƠn hàng
    $sqlDonHang = "SELECT donhang.id_donhang,donhang.id_sales,donhang.masothue,donhang.booking,donhang.loaihang,donhang.id_hangtau,
    donhang.id_nhomhanghoa,donhang.id_hanghoa,donhang.soluong,donhang.sokg,donhang.trangthai,donhang.ngaydongcontainer,
    donhang.giodongcontainer,donhang.id_tuyenvantai,donhang.culy,donhang.dautieuthu,donhang.ngaycatmang,donhang.nguoigiaonhan,
    donhang.dienthoai,donhang.giacuoc,donhang.thuthutuc,donhang.thukhac,donhang.hanthanhtoan,donhang.ghichu,
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-5 mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="sales_tamung"
                                                        placeholder="Sales" value="<?php echo $items['tensales']; ?>" readonly>
                                                </div>
                                                ...
                                                <div class="col-md-3 mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="nhomhanghoa_tamung"
                                                        ...
                                                        placeholder="nhomhanghoa" readonly>
                                                </div>
                                                ...
                                                <div class="col-md-3 mb-3">
                                                    ...
                                                    <div class="input-group mb-2">
                                                        <input type="text" class="form-control" id="trongluong_tamung"
                                                            placeholder="trongluong" value="<?php echo $items['sokg']; ?>"
                                                            readonly>
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-12 mb-3">
                                                    <input type="hidden" readonly class="form-control" name="id_edit"
                                                        id="validationCustom01" placeholder="Mã tạm ứng"
                                                        value="<?php echo $itemsTU['id_ctdhtu']; ?>" required>
                                                </div>
                                                <div class="col-md-3  mb-3">
                                                ...
                                                <div class="col-md-3 mb-3">
                                                    ...
                                                    <input type="date" class="form-control" name="ngaytamung" id="ngaytamung"
                                                        placeholder="Chọn ngày tạm ứng"
                                                        value="<?php echo $itemsTU['ngaytamung']; ?>" required>
                                                    <div class="invalid-feedback">
                                                        Ngày tạm ứng.
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-3 mb-3">
                                                    ...
                                                    <input type="date" class="form-control" name="ngaythanhtoan_tamung"
                                                        ...
                                                        value="<?php echo $itemsTU['ngaythanhtoan']; ?>">
                                                </div>
                                                ...
                                                <div class="col-md-3 mb-3">
                                                    ...
                                                    <input type="time" class="form-control" name="giothanhtoan_tamung"
                                                        ...
                                                        value="<?php echo $itemsTU['giothanhtoan']; ?>">
                                                </div>

                                                <div class="col-md-3 mb-3">
                                                    <label for="tiencuocvo_tamung">Tiền cước vỏ :</label>
                                                    <input type="text" class="form-control" id="tiencuocvo_tamung_display"
                                                        placeholder="Nhập tiền cước vỏ..."
                                                        value="<?php echo $itemsTU['tiencuocvo']; ?>">
                                                ...
                                                <div class="col-md-3 mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="tienhaiquan_tamung_display"
                                                        placeholder="Nhập tiền hải quan..."
                                                        value="<?php echo $itemsTU['tienhaiquan']; ?>">
                                                    <input type="hidden" name="tienhaiquan_tamung" id="tienhaiquan_tamung"
                                                        value="<?php echo $itemsTU['tienhaiquan']; ?>">
                                                </div>
                                                <!--  chỉ cho nhập số và định dạng -->
                                                <script>
                                                ...
                                                <div class="col-md-3 mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="tiennangha_tamung_display"
                                                        placeholder="Nhập tiền nâng hạ..."
                                                        value="<?php echo $itemsTU['tiennangha']; ?>">
                                                ...
                                                <div class="col-md-3 mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="tienkhac_tamung_display"
                                                        placeholder="Nhập tiền khác..." value="<?php echo $itemsTU['tienkhac']; ?>">
                                                    <input type="hidden" name="tienkhac_tamung" id="tienkhac_tamung"
                                                        value="<?php echo $itemsTU['tienkhac']; ?>">
                                                </div>
                                                ...
                                                <div class="col-md-12 mb-3">
                                                    ...
                                                    <a class="mt-3" width="100px" href="img/<?php echo $itemsTU['anh1']; ?>"
                                                        target="_blank">
                                                        <img class="mt-3" width="100px"
                                                            src="img/<?php echo $itemsTU['anh1']; ?>">
                                                    </a>
                                                </div>
                                                ...
                                                <div class="col-md-12 mb-3">
                                                    ...
                                                    <textarea class="form-control" name="ghichu_tamung" id="ghichu_tamung"
                                                        ...
                                                        rows="3"> <?php echo $itemsTU['ghichu']; ?></textarea>
