                                            ...
                                            <div class="card-body">
                                                <div class="form-row">
                                                    ...
                                                    <div class="col-md-3 mb-3">
                                                        ...
                                                        <div class="input-group mb-2 d-flex calculation-input">
                                                            <input class="form-control" id="tiencuocvo_cpvt"
                                                                placeholder="Tiền cước vỏ..." value="" readonly></input>
                                                            <div class="input-group-prepend">
                                                                <div
                                                                    class="input-group-text rounded-right text-gray-100 bg-gradient-primary">
                                                                    VNĐ</div>
                                                    ...
                                                    <div class="col-md-3 mb-3">
                                                        ...
                                                        <div class="input-group mb-2 d-flex calculation-input">
                                                            <input class="form-control" id="tienhaiquan_cpvt"
                                                                placeholder="Tiền hải quan..." value=""
                                                                readonly></input>
                                                            <div class="input-group-prepend">
                                                                <div
                                                                    class="input-group-text rounded-right text-gray-100 bg-gradient-primary">
                                                    ...
                                                    <div class="col-md-3 mb-3">
                                                        ...
                                                        <div class="input-group mb-2 d-flex calculation-input">
                                                            <input class="form-control" id="tiennangha_cpvt"
                                                                placeholder="Tiền nâng hạ..." value="" readonly></input>
                                                            <div class="input-group-prepend">
                                                                <div
                                                                    class="input-group-text rounded-right text-gray-100 bg-gradient-primary">
                                                                    VNĐ</div>
                                                    ...
                                                    <div class="col-md-3 mb-3">
                                                        ...
                                                        <div class="input-group mb-2 d-flex calculation-input">
                                                            <input class="form-control" id="tienkhac_cpvt"
                                                                placeholder="Tiền khác..." value="" readonly></input>
                                                            <div class="input-group-prepend">
                                                                <div
                                                                    class="input-group-text rounded-right text-gray-100 bg-gradient-primary">
                                                                    VNĐ</div>
