...
if (isset($_POST['login'])) {
    ...
    $stmt = $conn->prepare("SELECT * FROM admin_info WHERE admin_username = :username AND admin_password = :password");
    ...
    if ($rowCount == 1) {
        ...
        exit; // Đảm bảo không có mã HTML hoặc mã PHP được thực thi sau khi chuyển hướng
    } else {
        // Đăng nhập thất bại
