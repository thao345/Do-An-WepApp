...
if (isset($_GET['filter']))
    if (isset($_GET['from_date']) && isset($_GET['to_date'])) {
        ...
        $table = "tuyenvantai";
        $columns = array("$table.id_$table", "$table.ten", "$table.diemdau", "$table.chucvu", "$table.nguyenquan", "$table.diachithuongtru", "$table.ngaysinh", "$table.cmnd", "$table.sđt", "$table.stk", "$table.tennganhang");
