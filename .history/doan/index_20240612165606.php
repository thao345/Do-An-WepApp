...
$sql7 = "SELECT xe.id_xe, xe.bienso, COUNT(donhang.id_donhang) AS so_don_hang_hoan_thanh
        FROM xe
        INNER JOIN dieuhanh ON xe.id_xe = dieuhanh.id_xe
        INNER JOIN donhang ON donhang.id_donhang = dieuhanh.id_donhang
        WHERE donhang.trangthai = 'Hoàn thành'
        GROUP BY xe.id_xe, xe.bienso
        ORDER BY so_don_hang_hoan_thanh DESC
        LIMIT 3;";
...
$sql8 = "SELECT taixe.id_taixe, taixe.ten, COUNT(donhang.id_donhang) AS so_don_hang_hoan_thanh
        FROM taixe
        INNER JOIN dieuhanh ON taixe.id_taixe = dieuhanh.id_taixe
        INNER JOIN donhang ON donhang.id_donhang = dieuhanh.id_donhang
        WHERE donhang.trangthai = 'Hoàn thành'
        GROUP BY taixe.id_taixe, taixe.ten
        ORDER BY so_don_hang_hoan_thanh DESC
        LIMIT 3;";
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="tables-container" style="">
                            <div class="table-wrapper" style>
                                <h3 class="mt-3">Danh sách xe hoàn thành đơn hàng</h3>
                                <table id="xe-hoan-thanh" class="table  table-bordered table-hover" style="text-align:center;">
                                    <thead>
                                        <tr>
                                            <th>STT</th>
                                            <th>Mã xe</th>
                                    ...
                                    <?php
                                    $stt = 1;
                                    foreach ($resultxe as $items): ?>

                                        <tbody>
                                            <tr>
                                                <td><?php echo $stt++; ?></td>
                                                <td><?php echo $items['id_xe'] ?></td>
                                                <td><?php echo $items['bienso'] ?></td>
                                                <td><?php echo $items['so_don_hang_hoan_thanh'] ?></td>
                                            </tr>
                                        </tbody>
                                    <?php endforeach ?>
                                ...
                                <a href="list_xehoanthanh.php" class="btn btn-primary"><i class="fa-solid fa-magnifying-glass mr-2"></i>Danh sách chi tiết xe</a>
                            </div>
                            <div class="table-wrapper">
                                <h3 class="mt-3">Danh sách tài xế hoàn thành đơn hàng</h3>
                                <table id="tai-xe-hoan-thanh" class="table  table-bordered table-hover" style="text-align:center;">
                                    ...
                                    <?php
                                    $stt = 1;
                                    foreach ($resulttaixe as $items): ?>

                                        <tbody>
                                            <tr>
                                                <td><?php echo $stt++; ?></td>
                                                <td><?php echo $items['id_taixe'] ?></td>
                                ...
                                <a href="list_taixehoanthanh.php" class="btn btn-primary"><i class="fa-solid fa-magnifying-glass  mr-2"></i>Danh sách chi tiết tài xế</a>
