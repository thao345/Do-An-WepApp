                ...
                <?php foreach ($result as $items): ?>
                    <div class="form-row">
                        <div class="col-md-8 mb-3">
                            ...
                            <input type="text" class="form-control" name="id_xe" id="validationCustom01"
                        ...
                        <div class="col-md-3  mb-3">
                                        ...
                                        <select name="select_TP" class="" id="select_TP" required>
                                            ...
                                            <?php foreach ($resultTP as $itemsTP): ?>
                                                <option value="<?php echo $itemsTP['id_thauphu']; ?>" <?php echo ($itemsTP['id_nhomhanghoa'] == $items['id_nhomhang']) ? 'selected' : ''; ?>>
