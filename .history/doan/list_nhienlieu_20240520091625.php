...
$sql = "SELECT nhienlieu.id_nhienlieu, nhienlieu.ten,nhienlieu. nguoidung.tendangnhap AS nguoitao, nguoidung.id_nguoidung, DATE(nhienlieu.ngaytao) as ngaytao, nguoidung2.tendangnhap AS nguoisua, nguoidung2.id_nguoidung, DATE(nhienlieu.ngaysua) as ngaysua
        FROM nhienlieu
