...
$sqlBase = "SELECT nhatky.id_nhatky, nhatky.ten, nguoidung.tendangnhap AS nguoitao, nguoidung.id_nguoidung, DATE(nhatky.ngaytao) as ngaytao, nguoidung2.tendangnhap AS nguoisua, nguoidung2.id_nguoidung, DATE(nhatky.ngaysua) as ngaysua
            FROM nhatky
            INNER JOIN nguoidung ON nhatky.id_nguoitao = nguoidung.id_nguoidung
            LEFT JOIN nguoidung AS nguoidung2 ON nhatky.id_nguoisua = nguoidung2.id_nguoidung";

$sql = "$sqlBase WHERE 1
        ORDER BY nhatky.ngaytao DESC
...
if (isset($_GET['filter'])) {
    if (isset($_GET['from_date']) && isset($_GET['to_date'])) {
        ...
        $sql = "$sqlBase 
                WHERE nhatky.ngaytao BETWEEN '$from_date  00:00:00' AND '$to_date 23:59:59'
                ORDER BY nhatky.ngaytao DESC
                LIMIT $offset,$total_records_per_page";
...
<div id="content-wrapper" class="d-flex flex-column">
            ...
            <div class="d-flex">
                ...
                <form class="form-inline ml-auto mr-4 border p-3 rounded filternhatky" method="GET">
                    ...
                    <div class="form-group ml-3">
                        ...
                        <a href="list_nhatky.php" class="btn btn-danger">Làm mới</a>
                            ...
                            <form class="needs-validation" novalidate action="them_nhatky.php" method="POST">
                                <div class="form-row">
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <input type="text" class="form-control" name="id_nhatky"
                        ...
                        <tbody style=" white-space: nowrap;">
                            ...
                            foreach ($result as $items):
                                ...
                                <tr data-id="<?php echo $items['id_nhatky']; ?>">
                                    ...
                                    <td>
                                        <form action="sua_nhatky.php" method="POST">
                                            <input type="hidden" name="edit_id"
                                                value="<?php echo $items['id_nhatky']; ?>">
                                            <button name="suabtn" class="btn btn-success">Sửa</button>
                                        </form>
                                    </td>
                                    <td>
                                        <!-- Thêm modal dialog -->
                                        <div class="modal" id="deleteModal-<?php echo $items['id_nhatky']; ?>"
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <form action="them_nhatky.php" method="POST">
                                        ...
                                        <button class="btn btn-danger" data-toggle="modal"
                                            data-target="#deleteModal-<?php echo $items['id_nhatky']; ?>">Xoá</button>
                                    </td>
                                </tr>
    ...
    <script>
        ...
        $('tr[data-id]').on('dblclick', function () {
            ...
            window.location.href = 'sua_nhatky.php?edit_id=' + id;
        });
