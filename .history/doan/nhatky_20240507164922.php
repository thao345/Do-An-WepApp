...
$sqlGetMonth = "SELECT DATE_FORMAT(nhatky.thoigian, '%m') AS thang FROM nhatky; ";
$result = mysqli_query($conn, $sql);

// Mảng để lưu trữ các tháng đã xuất hiện
$months = array();
...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    if (!in_array($month, $months)) {
        // Nếu chưa tồn tại, thêm vào mảng và hiển thị tùy chọn trong thẻ select
