...
<body>
    ...
    <div class="input-group">
        <input type="password" class="form-control form-control-user" name="password"
               id="password" placeholder="Mật khẩu" required style="border-top-right-radius: 0; border-bottom-right-radius: 0;">
...
<style>
    ...
    .btn-outline-secondary {
        border: 1px solid #ced4da; /* Ensure matching border color */
    }
    .btn-outline-secondary {
