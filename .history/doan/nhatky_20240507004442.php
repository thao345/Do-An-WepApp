                        ...
                        <tbody style=" white-space: nowrap;">
                            ...
                            foreach ($result as $items):
                                ...
                                <tr data-id="<?php echo $items['id_nhatky']; ?>">
                                    ...
                                    <td>
                                        <button type="button" id="deleteModal-<?php echo $items['id_tinhthanh']; ?>" class="btn btn-success" data-toggle="modal"
                                            data-target="#exampleModal-<?php echo $items['id_tinhthanh']; ?>" data-whatever="@mdo">Xem chi tiết</button>
