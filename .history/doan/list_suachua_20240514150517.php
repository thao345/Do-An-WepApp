...
if (isset($_GET['filter'])) {
    ...
    if (!empty($from_date)) {
        ...
        $sql .= " AND suachua.ngaytao >= :from_date";
    }

    if (!empty($to_date)) {
        // Thêm điều kiện tìm kiếm theo đến ngày
        $sql .= " AND suachua.ngaytao <= :to_date";
    }

    $sql .= " ORDER BY suachua.ngaytao DESC LIMIT $offset, $total_records_per_page";
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <div class="input-group mb-2">
                                            <input type="text" class="form-control" name="tiennhancong"
                                                id="tiennhancong" placeholder="Nhập tiền nhân công..." value="">
                                            <div class="input-group-prepend">
                                                <div
                                                    class="input-group-text rounded-right text-gray-100 bg-gradient-primary">
                                                    VNĐ</div>
                        ...
                        <tbody style=" white-space: nowrap;">
                            ...
                            foreach ($result as $items):
                                ...
                                <tr data-id="<?php echo $items['id_suachua']; ?>"
                                    ...
                                    <td>
                                        <?php echo date('d-m-Y', strtotime($items['ngaysua'])); ?>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        ...
                                        <button class="btn btn-danger" data-toggle="modal"
                                            data-target="#deleteModal<?php echo $items['id_suachua']; ?>" <?php echo $disableXoa; ?>>Xoá</button>
                                    </td>
                                </tr>
