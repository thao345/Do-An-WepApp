                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group ml-3">
                            ...
                            <select disabled class="form-control mr-5" name="nguoithuchien" id="exampleFormControlSelect1"
                                ...
                                <option value="">Lọc theo người thực</option>
                                <?php foreach ($resultTVT as $itemsTVT): ?>
                                                <option value="<?php echo $itemsTVT['id_tuyenvantai']; ?>" <?php echo isset($_GET['nguoithuchien']) == true ? ($_GET['nguoithuchien'] == 'Hủy' ? 'selected' : '') : ''; ?> required>
