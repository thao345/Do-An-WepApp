...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <!-- Page Heading -->
            <h1 class="h3 mb-4 text-gray-800  text-center header-crud">SNHa</h1>

            <form class="needs-validation" novalidate action="them_nhatky.php" method="POST">
                <?php foreach ($result as $items): ?>
                    <div class="form-row">
                        <div class="col-md-12 mb-3">
                            <label for="validationCustom01">NHa</label>
                            <input type="text" readonly class="form-control" name="id_edit" id="validationCustom01"
                                placeholder="NHa" value="<?php echo $items['id_nhatky']; ?>" required>
                            <div class="invalid-feedback">
                                Nhập NHa.
                            </div>
                        </div>
                        <div class="col-md-12 mb-3">
                            <label for="validationCustom02">TNHa</label>
                            <input type="text" class="form-control" name="ten_edit" id="validationCustom02"
                                placeholder="TNHa" value="<?php echo $items['ten']; ?>" required>
                            <div class="invalid-feedback">
                                Nhập tNHa.
                            </div>
                        </div>
