...
if (isset($_GET['filter']))
    if (isset($_GET['from_date']) && isset($_GET['to_date'])) {
        ...
        tuyenvantai.ten,tuyenvantai.diemdau,tuyenvantai.id_tinhthanhdau,tuyenvantai., tuyenvantai.id_tinhthanhcuoi,tuyenvantai.culy, tuyenvantai.dautieuthu,tuyenvantai.ghichu
