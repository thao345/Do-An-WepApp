...
if (isset($_GET['filter'])) {
    ...
    $sql = "SELECT chitietdonhangtamung.id_ctdhtu, chitietdonhangtamung.id_donhang, DATE(chitietdonhangtamung.ngaytamung) as ngaytamung, chitietdonhangtamung.id_nhansu as idnhansutamung, nhansu.ten as tennhansutamung, chitietdonhangtamung.tiencuocvo, chitietdonhangtamung.tienhaiquan, chitietdonhangtamung.tiennangha, chitietdonhangtamung.ngaythanhtoan, chitietdonhangtamung.giothanhtoan, chitietdonhangtamung.ghichu, chitietdonhangtamung.anh1, donhang.booking, DATE(donhang.ngaytao) as ngaytaodonhang, donhang.loaihang, donhang.id_nhomhanghoa, nhomhanghoa.ten as tennhomhanghoa, donhang.id_hanghoa, hanghoa.ten as tenhanghoa, donhang.sokg, donhang.id_khachhang, khachhang.ten as tenkhachhang, donhang.id_tuyenvantai, tuyenvantai.ten as tentuyenvantai, nguoidung.tendangnhap AS nguoitao, nguoidung.id_nguoidung, DATE(chitietdonhangtamung.ngaytao) as ngaytao, nguoidung2.tendangnhap AS nguoisua, nguoidung2.id_nguoidung, DATE(chitietdonhangtamung.ngaysua) as ngaysua
    FROM chitietdonhangtamung 
    INNER JOIN nguoidung ON chitietdonhangtamung.id_nguoitao = nguoidung.id_nguoidung
    LEFT JOIN nguoidung AS nguoidung2 ON chitietdonhangtamung.id_nguoisua = nguoidung2.id_nguoidung
    INNER JOIN donhang ON donhang.id_donhang = chitietdonhangtamung.id_donhang
            ...
            <div class="d-flex">
                ...
                <form class="form-inline ml-auto mr-4 border p-3 rounded filterDonHang " method="GET">
                    <div class="form-group">
                        ...
                        <label class="mr-2" for="exampleFormControlSelect1">Cán bộ tạm ứng: </label>
                                ...
                                <tr data-id="<?php echo $items['id_ctdhtu']; ?>"
                                    ...
                                    <td>
                                        <form action="sua_tamung.php" method="POST">
                                            ...
                                            <button name="suabtn" class="btn btn-info" <?php echo $disableSua; ?>>Sửa</button>
                                        </form>
                                    </td>
                                    <td>
                                        <!-- Thêm modal dialog -->
                                        ...
                                        <button class="btn btn-danger" data-toggle="modal"
                                            data-target="#deleteModal<?php echo $items['id_ctdhtu']; ?>" <?php echo $disableXoa; ?>>Xoá</button>
                                    </td>
                                </tr>
