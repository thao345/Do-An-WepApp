                    ...
                    $(document).ready(function () {
                        ...
                        $('#xoabtn').click(function () {
                            ...
                            if (selectedMonth) {
                                ...
                                // Hiển thị giá trị tháng trong hộp thoại xác nhận
                                $('#thangToDelete').text("Bạn có chắc chắn muốn xoá tất cả nhật ký trong tháng " + selectedMonth + "?");

                                // Hiển thị hộp thoại xác nhận
                                $('#confirmDeleteModal').modal('show');
                            } else {
                                // Nếu người dùng chưa chọn tháng, hiển thị thông báo lỗi
                        ...
                        $('#confirmDeleteBtn').click(function () {
                            var thangXoa = $('#confirmDeleteModal').attr('data-thang-xoa');
                            $.ajax({
                                url: 'ajax/delete_nhat_ky_theo_thang.php', // Đường dẫn tới script xử lý xoá dữ liệu theo tháng
                                method: 'POST',
                                data: { thang: thangXoa }, // Truyền giá trị tháng vào script xử lý
