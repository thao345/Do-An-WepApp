                        ...
                        <tbody style=" white-space: nowrap;">
                            ...
                            foreach ($result as $items):
                                ...
                                <tr data-id="<?php echo $items['id_nhatky']; ?>">
                                    ...
                                    <td>
                                        <form action="xem_nhatky.php" method="POST">
                                            <input type="hidden" name="edit_id" value="<?php echo $items['id_nhatky']; ?>">
                                            <button name="suabtn" class="btn btn-success">Xem</button>
                                        </form>
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form class="needs-validation" novalidate
                                                            action="them_tinhthanh.php" method="POST">
                                                            <div class="form-row">
                                                                <div class="col-md-12 mb-3">
                                                                    <label for="validationCustom01">Mã tỉnh thành</label>
                                                                    <input type="text" class="form-control"
                                                                        name="id_tinhthanh" id="validationCustom01"
                                                                        placeholder="Mã tỉnh thành" value="" required>
                                                                ...
                                                                <div class="col-md-12 mb-3">
                                                                    ...
                                                                    <input type="text" class="form-control" name="ten"
                                                                        id="validationCustom02" placeholder="Tên tỉnh thành"
                                                                        value="" required>
                                                                    <div class="invalid-feedback">
                                                                        Nhập tên tỉnh thành.
                                                                    </div>
                                                            ...
                                                            <div class="modal-footer">
                                                                <button type="button" class="btn btn-secondary"
                                                                    ...
                                                                    lại</button>
                                                                <button type="submit" name="thembtn"
