...
$sql = "SELECT tuyenvantai.id_tuyenvantai, tuyenvantai.ten, tuyenvantai.diemdau, tinhthanh.ten as tinhthanhdau, tuyenvantai.diemcuoi, tinhthanh2.ten as tinhthanhcuoi, tuyenvantai.culy, tuyenvantai.dautieuthu,tuyenvantai.ghichu,tuyenvantai.ngaytao, nguoidung.tendangnhap AS nguoitao, nguoidung.id_nguoidung, DATE(tuyenvantai.ngaytao) as ngaytao, nguoidung2.tendangnhap AS nguoisua, nguoidung2.id_nguoidung, DATE(tuyenvantai.ngaysua) as ngaysua
        FROM tuyenvantai
        INNER JOIN tinhthanh ON tuyenvantai.id_tinhthanhdau = tinhthanh.id_tinhthanh
        LEFT JOIN tinhthanh  AS tinhthanh2 ON tuyenvantai.id_tinhthanhcuoi = tinhthanh2.id_tinhthanh
        INNER JOIN nguoidung ON tuyenvantai.id_nguoitao = nguoidung.id_nguoidung
...
if (isset($_GET['filter']))
    if (isset($_GET['from_date']) && isset($_GET['to_date'])) {
        ...
        LEFT JOIN tinhthanh  AS tinhthanh2 ON tuyenvantai.id_tinhthanhcuoi = tinhthanh2.id_tinhthanh
         INNER JOIN nguoidung ON tuyenvantai.id_nguoitao = nguoidung.id_nguoidung
        LEFT JOIN nguoidung AS nguoidung2 ON tuyenvantai.id_nguoisua = nguoidung2.id_nguoidung
        WHERE tuyenvantai.ngaytao BETWEEN '$from_date  00:00:00' AND '$to_date 23:59:59'
        ORDER BY tuyenvantai.ngaytao DESC
        LIMIT $offset,$total_records_per_page";
        $stmt = $conn->prepare($sql);
        $query = $stmt->execute();
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control" name="diemdau" id="validationCustom02"
                                            placeholder="Điểm đầu" value="" required>
                                        <div class="invalid-feedback">
                                            Điểm đầu.
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control" name="diemcuoi" id="validationCustom02"
                                            placeholder="Điểm cuối" value="" required>
                                        <div class="invalid-feedback">
                                            Điểm cuối.
                                        </div>
                                    </div>
                ...
                <table class=" table  table-bordered table-hover " id="myTable" width="100%" cellspacing="0">
                        <thead style=" white-space: nowrap;" class="thead-dark">
                            <tr>
                                 ...
                                 <th class="text-center">Tỉnh thành đầu</th>
                                 <th class="text-center">Điểm cuối</th>
                                 <th class="text-center">Tỉnh thành cuối</th>
                                 <th class="text-center">Cự ly (km)</th>
                                 <th class="text-center">Dầu tiêu thụ (lít)</th>
                                ...
                                <tr data-id="<?php echo $items['id_tuyenvantai']; ?>">
                                    ...
                                    <td>
                                        <form action="sua_tuyenvantai.php" method="POST">
                                            <input type="hidden" name="edit_id"value="<?php echo $items['id_tuyenvantai']; ?>">
                                    ...
                                    <td>
                                        <!-- Thêm modal dialog -->
                                        <div class="modal" id="deleteModal<?php echo $items['id_tuyenvantai']; ?>" tabindex="-1" role="dialog">
                                        ...
                                        <!-- Nút "Xóa" -->
                                            ...
                                            data-target="#deleteModal<?php echo $items['id_tuyenvantai']; ?>">
