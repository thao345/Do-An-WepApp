...
if (isset($_GET['filter']))
    if (isset($_GET['from_date']) && isset($_GET['to_date'])) {
        ...
        $table = "tuyenvantai";
        $columns = array("$table.id_$table", "$table.ten", "$table.diemdau", "$table.id_tinhthanhdau", "$table.nguyenquan", "$table.diachithuongtru", "$table.ngaysinh", "$table.cmnd", "$table.sđt", "$table.stk", "$table.tennganhang");
        $result = filter($table, $columns, $from_date, $to_date, $offset, $total_records_per_page);
        tuyenvantai.id_tuyenvantai,
        tuyenvantai.ten,tuyenvantai.diemdau,tuyenvantai.id_tinhthanhdau,tuyenvantai.diemcuoi, tuyenvantai.id_tinhthanhcuoi,tuyenvantai.culy, tuyenvantai.dautieuthu,tuyenvantai.ghichu
