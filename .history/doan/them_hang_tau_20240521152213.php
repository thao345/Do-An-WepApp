...
if (isset($_POST['thembtn'])) {
    if (isset($_POST['id_hangtau']) && isset($_POST['ten'])) {
        ...
        $ten = $_POST['ten'];
        $sql = "INSERT INTO hangtau (id_hangtau, ten, id_nguoitao, ngaytao) VALUES ('$idtt', '$ten', '$id_nguoidung', current_timestamp())";
...
if (isset($_POST['luubtn'])) {
    ...
    $ten = $_POST['ten_edit'];
    $sql = "UPDATE hangtau
        SET id_hangtau='$idtt', ten = '$ten', id_nguoisua = '$id_nguoidung', ngaysua = current_timestamp()
...
if (isset($_POST['xoabtn'])) {
    ...
    $sql1 = "UPDATE `hangtau` SET `id_nguoisua`='$id_nguoidung' WHERE id_hangtau = '$id_hangtau'";
