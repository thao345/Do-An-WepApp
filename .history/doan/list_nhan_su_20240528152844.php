                                    ...
                                    <script>
                                        $(document).ready(function () {
                                            ...
                                            $('#ngaysinh').on('change', function () {
                                                ...
                                                var monthDifference = today.getMonth() - ngaysinh.getMonth();
                                                var dayDifference = today.getDate() - ngaysinh.getDate();
                                                ...
                                                if (age < 18 || age > 70) {
                                                    // Người dùng không nằm trong khoảng 18 đến 70 tuổi, hiển thị thông báo lỗi
                                                    $(this).closest('.col-md-4').find('.invalid-feedback').text('Yêu cầu nhân viên từ 18 đến 70 tuổi.');
                                                    $(this).addClass('is-invalid');
                                                } else {
                                                    // Người dùng nằm trong khoảng 18 đến 70 tuổi, xóa thông báo lỗi
                                                    $(this).closest('.col-md-4').find('.invalid-feedback').text('');
