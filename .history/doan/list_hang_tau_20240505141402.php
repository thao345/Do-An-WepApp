        ...
        <div class="container-fluid">
            ...
            <div class="d-flex">
                ...
                <button type="button" class="btn btn-primary " data-toggle="modal" data-target="#exampleModal"
                    data-whatever="@mdo">Thêm hãng tàu</button>
                            ...
                            <form class="needs-validation" novalidate action="them_hang_tau.php" method="POST">
                                <div class="form-row">
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" class="form-control" name="id_hangtau" id="validationCustom01"
                                            placeholder="Mã hãng tàu" value="" required>
                        ...
                        <tbody style=" white-space: nowrap;">
                            ...
                            foreach ($result as $items):
                                ...
                                <tr data-id="<?php echo $items['id_hangtau']; ?>">
                                    ...
                                    <td>
                                        <!-- Thêm modal dialog -->
                                        <div class="modal" id="deleteModal<?php echo $items['id_hangtau'];?>" tabindex="-1" role="dialog">
                                        ...
                                        <button class="btn btn-danger deleteBtn" data-toggle="modal" 
                                            ...
                                            data-id="<?php echo $item['id_hangtau'];?>"
                                            >Xoá</button>
                                    </td>
                                </tr>
