...
$sqlTVT = "SELECT * FROM `tuyenvantai` ";
                        ...
                        <div class="input-group ml-3">
                            ...
                            <select disabled class="form-control mr-5" name="nguoithuchien" id="exampleFormControlSelect1"
                                ...
                                <?php foreach ($resultND as $itemsND): ?>
                                                <option value="<?php echo $itemsND['id_tuyenvantai']; ?>" <?php echo isset($_GET['nguoithuchien']) == true ? ($_GET['nguoithuchien'] == 'Hủy' ? 'selected' : '') : ''; ?> required>
