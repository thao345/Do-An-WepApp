                                ...
                                <tr data-id="<?php echo $items['id_nhatky']; ?>">
                                    ...
                                    <td>
                                        <button type="button"  class="btn btn-success" data-toggle="modal"
                                            data-target="#exampleModal-<?php echo $items['id_nhatky']; ?>" data-whatever="@mdo">Xem chi tiết</button>

                                        <!-- Thêm modal dialog -->
                                        <div class="modal fade" id="exampleModal-<?php echo $items['id_nhatky']; ?>" tabindex="-1"
