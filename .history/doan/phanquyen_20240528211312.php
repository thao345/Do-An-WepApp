...
$id_nguoidung1 = $_POST['id_nguoidung'];
                    ...
                    <tbody>
                        <?php foreach ($result as $row): ?>
                            <tr>
                                ...
                                <td>
                                    <?php
                                    $sql_check_permission = "SELECT * FROM phanquyen WHERE id_nguoidung = " . $id_nguoidung1 . " AND id_chucnang = " . $row['id_chucnang'];
                                    ...
                                    <input type="hidden" name="id_nguoidung" value="<?php echo $id_nguoidung1; ?>">
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
