...
SELECT 
    tongtiensuachua_sum +
    tongchi_sum as tongchi_sum
FROM (
    SELECT 
        SUM(suachua.tongtien) AS tongtiensuachua_sum
    FROM suachua
...
(
    SELECT 
        SUM(
            phieudonhienlieu.thanhtien 
            + chitietdonhangtamung.tiencuocvo 
            + chitietdonhangtamung.tienhaiquan 
            + chitietdonhangtamung.tiennangha 
            + chitietdonhangtamung.tienkhac 
            + chiphivantai.phicauduong 
            + chiphivantai.tienanca 
            + chiphivantai.luongchuyen 
            + chiphivantai.luongchunhat 
            + chiphivantai.tienthuexengoai
        ) AS tongchi_sum
    FROM donhang
