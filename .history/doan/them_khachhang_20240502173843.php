...
if (isset($_POST['luubtn'])) {
    ...
    $sql = "UPDATE khachhang
        SET ten='$ten', diachi = '$diachi' ,sodienthoai ='$sodienthoai',  email = '$email', masothue = '$masothue',  tennganhang = '$tennganhang',  stk = '$stk',  masothue = '$masothue', id_nhomhanghoa = '$id_nhomhanghoa', 
