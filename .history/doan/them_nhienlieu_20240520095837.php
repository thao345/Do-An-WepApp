...
if (isset($_POST['thembtn'])) {
    ...
    isset($_POST['ngayapdung'])
        ...
        $sql = "INSERT INTO nhienlieu (id_nhienlieu, ten, dongiasauthue, ngayapdung id_nguoitao, ngaytao) VALUES ('$idtt', '$ten','$dongiasauthue','$ten', '$id_nguoidung', current_timestamp())";
