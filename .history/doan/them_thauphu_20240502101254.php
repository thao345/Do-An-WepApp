...
if (isset($_POST['thembtn'])) {
    if (
        ...
        $sql = "INSERT INTO `hanghoa`( `id_thauphu`, `ten`,`id_nhomhanghoa`, `kichthuoc`, `donvitinh`, 
        `ghichu`, `ngaytao`, `id_nguoitao`) 
        VALUES ('$id_thauphu', '$ten','$id_nhomhanghoa','$kichthuoc','$donvitinh','$ghichu', current_timestamp(),'5')";
