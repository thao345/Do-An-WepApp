...
if (isset($_POST['thembtn'])) {
    if (isset($_POST['id_donviccdau']) && isset($_POST['ten'])) {
        ...
        $ten = $_POST['ten'];
        $sql = "INSERT INTO don (id_donviccdau, ten, id_nguoitao, ngaytao) VALUES ('$idtt', '$ten', '2', current_timestamp())";
...
if (isset($_POST['luubtn'])) {
    ...
    $ten = $_POST['ten_edit'];
    $sql = "UPDATE don
        SET id_donviccdau='$idtt', ten = '$ten', id_nguoisua = '3', ngaysua = current_timestamp()
...
if (isset($_POST['xoabtn'])) {
    ...
    $sql = "DELETE FROM `don` WHERE id_donviccdau = '$idtt'";
    $stmt = $conn->prepare($sql);
    $query = $stmt->execute();
