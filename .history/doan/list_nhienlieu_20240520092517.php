...
$sql = "SELECT nhienlieu.id_nhienlieu, nhienlieu.ten, nhienlieu.dongiasauthue, nhienlieu.ngayapdung, nguoidung.tendangnhap AS nguoitao, nguoidung.id_nguoidung, DATE(nhienlieu.ngaytao) as ngaytao, nguoidung2.tendangnhap AS nguoisua, nguoidung2.id_nguoidung, DATE(nhienlieu.ngaysua) as ngaysua
        FROM nhienlieu
                        ...
                        <div class="modal-body">
                            <form class="needs-validation" novalidate action="them_nhienlieu.php" method="POST">
                                <div class="form-row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <label for="dongiasauthue">Đơn giá sau thuế</label>
                                        <div class="input-group">
                                            <input type="text" class="form-control" name="dongiasauthue"
                                                id="dongiasauthue" placeholder="Đơn giá sau thuế" value="" required>
                                            <div class="input-group-append">
                                    ...
                                    <script>
                                        document.getElementById('dongiasauthue').addEventListener('input', function (e) {
                                            var value = e.target.value.replace(/,/g, ''); // Remove commas
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="date" class="form-control" name="ngayapdung"
                                            id="validationCustom02" placeholder="Ngày áp dụng" value="" required>
                                        <div class="invalid-feedback">
                                            Ngày áp dụng.
                                        </div>
                                    </div>
                            ...
                            foreach ($result as $items):
                                ...
                                <tr data-id="<?php echo $items['id_nhienlieu']; ?>">
                                    ...
                                    <td>
                                        ...
                                        echo number_format($items['dongiasauthue'], 0, ',', '.') . " VNĐ";
                                        ?>
                                    </td>
                                    <td>
                                        <?php echo date('d-m-Y', strtotime($items['ngayapdung'])); ?>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <!-- Thêm modal dialog -->
                                        <div class="modal" id="deleteModal-<?php echo $items['id_nhienlieu']; ?>"
