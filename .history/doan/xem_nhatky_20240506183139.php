...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <!-- Page Heading -->
            <h1 class="h3 mb-4 text-gray-800  text-center header-crud">SNhâ</h1>

            <form class="needs-validation" novalidate action="them_nhatky.php" method="POST">
                <?php foreach ($result as $items): ?>
                    <div class="form-row">
                        <div class="col-md-12 mb-3">
                            <label for="validationCustom01">Nhâ</label>
                            <input type="text" readonly class="form-control" name="id_edit" id="validationCustom01"
                                placeholder="Nhâ" value="<?php echo $items['id_nhatky']; ?>" required>
                            <div class="invalid-feedback">
                                Nhập Nhâ.
                            </div>
                        </div>
                        <div class="col-md-12 mb-3">
                            <label for="validationCustom02">TNhâ</label>
                            <input type="text" class="form-control" name="ten_edit" id="validationCustom02"
                                placeholder="TNhâ" value="<?php echo $items['ten']; ?>" required>
                            <div class="invalid-feedback">
                                Nhập tNhâ.
                            </div>
                        </div>
