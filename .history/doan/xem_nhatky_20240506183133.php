...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <!-- Page Heading -->
            <h1 class="h3 mb-4 text-gray-800  text-center header-crud">S</h1>
                    ...
                    <div class="form-row">
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="text" readonly class="form-control" name="id_edit" id="validationCustom01"
                                placeholder="" value="<?php echo $items['id_nhatky']; ?>" required>
                            <div class="invalid-feedback">
                                Nhập .
                            </div>
                        </div>
                        <div class="col-md-12 mb-3">
                            <label for="validationCustom02">T</label>
                            <input type="text" class="form-control" name="ten_edit" id="validationCustom02"
                                placeholder="T" value="<?php echo $items['ten']; ?>" required>
                            <div class="invalid-feedback">
                                Nhập t.
                            </div>
                        </div>
