...
$sqlCount = "SELECT COUNT(*) as total_rows FROM hangtau";
...
$sql = "SELECT hangtau.id_hangtau,hangtau.ten,hangtau.ngaytao, nguoidung.tendangnhap AS nguoitao, nguoidung.id_nguoidung, DATE(hangtau.ngaytao) as ngaytao, nguoidung2.tendangnhap AS nguoisua, nguoidung2.id_nguoidung, DATE(hangtau.ngaysua) as ngaysua
...
if (isset($_GET['filter'])) {
    if (isset($_GET['from_date']) && isset($_GET['to_date'])) {
        ...
        $sql = "SELECT hangtau.id_hangtau, hangtau.ten, hangtau.tenphongban,hangtau.chucvu, hangtau.nguyenquan, hangtau.diachithuongtru, hangtau.ngaysinh, hangtau.cmnd, hangtau.sđt, hangtau.stk,hangtau.tennganhang, nguoidung.tendangnhap AS nguoitao, nguoidung.id_nguoidung, DATE(hangtau.ngaytao) as ngaytao, nguoidung2.tendangnhap AS nguoisua, nguoidung2.id_nguoidung, DATE(hangtau.ngaysua) as ngaysua
                FROM hangtau INNER JOIN nguoidung ON hangtau.id_nguoitao = nguoidung.id_nguoidung
                LEFT JOIN nguoidung AS nguoidung2 ON hangtau.id_nguoisua = nguoidung2.id_nguoidung
...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <!-- Page Heading -->
            <h1 class="h3 mb-4 text-gray-800  text-center header-crud">Danh sách hãng tàu</h1>
            <!-- Topbar Search -->
            <div class="d-flex">
                <button type="button" class="btn btn-primary align-self-center" data-toggle="modal"
                    data-target="#exampleModal" data-whatever="@mdo">Thêm hãng tàu</button>
                ...
                <form class="form-inline ml-auto mr-4 border p-3 rounded filterHangTau" method="GET">
                ...
                <div class="modal-dialog modal-lg modal-dialog-centered  modal-dialog-scrollable">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form class="needs-validation" novalidate action="them_hang_tau.php" method="POST">
                                <div class="form-row">
                                    <div class="col-md-4 mb-3">
                                        <label for="validationCustom01">Mã hãng tàu</label>
                                        <input type="text" class="form-control" name="id_hangtau"
                                            id="validationCustom01" placeholder="Mã hãng tàu" value="" required>
                                        <div class="invalid-feedback">
                                            Nhập mã hãng tàu.
                                        </div>
                                    </div>
                                    <div class="col-md-8 mb-3">
                                        <label for="validationCustom02">Tên hãng tàu</label>
                                        <input type="text" class="form-control" name="ten" id="validationCustom02"
                                            placeholder="Tên hãng tàu" value="" required>
                                        <div class="invalid-feedback">
                                            Nhập tên hãng tàu.
                                        </div>
                                    </div>
                    ...
                    <table class=" table table-striped table-bordered table-hover " id="myTable" width="100%"
                        ...
                        <tbody style=" white-space: nowrap;">
                            ...
                            foreach ($result as $items):
                                ...
                                <tr data-id="<?php echo $items['id_hangtau']; ?>">
                                    <td>
                                        <?php echo $count++; ?>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <form action="sua_hang_tau.php" method="POST">
                                            <input type="hidden" name="edit_id" value="<?php echo $items['id_hangtau']; ?>">
                                            <button name="suabtn" class="btn btn-success">Sửa</button>
                                        </form>
                                    </td>
                                    <td>
                                        <!-- Thêm modal dialog -->
                                        <div class="modal" id="deleteModal<?php echo $items['id_hangtau']; ?>" tabindex="-1"
                                            role="dialog">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <p>Bạn có chắc chắn muốn xóa hãng tàu
                                                            <?php echo $items['ten']; ?>?
                                                        </p>
                                                    </div>
                                                    <div class="modal-footer">
                                                        ...
                                                        <form action="them_hang_tau.php" method="POST">
                                                            <input type="hidden" name="delete_id"
                                                                value="<?php echo $items['id_hangtau']; ?>">
                                        ...
                                        <button class="btn btn-danger deleteBtn" data-toggle="modal"
                                            data-target="#deleteModal<?php echo $items['id_hangtau']; ?>"
                                            data-id="<?php echo $item['id_hangtau']; ?>">Xoá</button>
                                    </td>
                                </tr>
    ...
    <script>
        ...
        $('tr[data-id]').on('dblclick', function () {
            ...
            window.location.href = 'sua_hang_tau.php?edit_id=' + id;
        });
