...
if (isset($_POST['thembtn'])) {
    if (
        ...
        VALUES ('$id_khachhang', '$ten','$diachi','$sodienthoai', '$email','$masothue','$tennganhang', '$stk', '$nguoidaidien', '$sđtgiaonhan', '$id_tuyenvantai', current_timestamp(),'$id_nguoidung')";
...
if (isset($_POST['luubtn'])) {
    ...
    $sql = "UPDATE khachhang
        SET ten='$ten', diachi = '$diachi' ,sodienthoai ='$sodienthoai',  email = '$email', masothue = '$masothue',  
        tennganhang = '$tennganhang',  stk = '$stk',  nguoidaidien = '$nguoidaidien',  sđtgiaonhan = '$sđtgiaonhan', id_tuyenvantai = '$id_tuyenvantai', 
...
if (isset($_POST['xoabtn'])) {
    ...
    $sql1 = "UPDATE `khachhang` SET `id_nguoisua`='$id_nguoidung' WHERE id_khachhang = '$id'";
