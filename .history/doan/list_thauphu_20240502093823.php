...
$sql = "SELECT thauphu.id_thauphu, thauphu.ten, nhomthauphu.ten AS tennhomthauphu, thauphu.kichthuoc, thauphu.donvitinh, thauphu.ghichu, nguoidung.tendangnhap AS nguoitao, nguoidung.id_nguoidung, DATE(thauphu.ngaytao) as ngaytao, nguoidung2.tendangnhap AS nguoisua, nguoidung2.id_nguoidung, DATE(thauphu.ngaysua) as ngaysua
        FROM thauphu
...
$sqlnhomthauphu = "SELECT * FROM nhomthauphu";
$stmt1 = $conn->prepare($sqlnhomthauphu);
$query = $stmt1->execute();
$resultnhomthauphu = array();
