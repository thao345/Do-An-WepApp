...
if (isset($_POST['thembtn'])) {
    if (
        ...
        '$tiennhancong', '$soluong','$nguoisuachua','$thoigianbaohanh','$tongtien','$image','$ghichu',current_timestamp(),'5')";
...
if (isset($_POST['luubtn'])) {
    ...
    `tongtien`='$tongtien',`anh1`='$image',`ghichu`='$ghichu',`ngaysua`=current_timestamp(),`id_nguoisua`='3'
...
if (isset($_POST['xoabtn'])) {
    ...
    $sql1 = "UPDATE `suachua` SET `id_nguoisua`='2' WHERE id_suachua = '$id_suachua'";
