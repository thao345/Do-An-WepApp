        ...
        <div class="container-fluid">
            ...
            <div class="d-flex">
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                Bạn có chắc chắn muốn xoá tất cả nhật ký trong tháng <p id="thangToDelete"></p>?
                            </div>
                            <div class="modal-footer">
                ...
                if (isset($_POST['xoabtn'])) {
                    // Lấy giá trị tháng từ biến POST
                    $selectedMonth = $_POST['thang'];

                    // Kiểm tra xem giá trị tháng có tồn tại không
                    if (!empty($selectedMonth)) {
                        // Hiển thị giá trị tháng trong hộp thoại xác nhận
                        echo '<script>';
                        echo 'document.addEventListener("DOMContentLoaded", function() {';
                        echo '    document.getElementById("thangToDelete").innerText = "' . $selectedMonth . '";';
                        echo '    document.getElementById("confirmDeleteModal").classList.add("show");';
                        echo '    document.getElementById("confirmDeleteModal").style.display = "block";';
                        echo '    document.querySelector(".modal-backdrop").style.display = "block";';
                        echo '});';
                        echo '</script>';
                    } else {
                        // Nếu người dùng chưa chọn tháng, hiển thị thông báo lỗi
                        echo '<script>alert("Vui lòng chọn tháng trước khi xoá.");</script>';
                    }
                }
                ?>
