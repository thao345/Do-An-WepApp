...
if (isset($_GET['from_date']) && isset($_GET['to_date'])) {
    $from_date = $_GET['from_date'];
        ...
        $table = "nhansu";
        $columns = array("$table.id_$table", "$table.ten", "$table.tenphongban","$table.chucvu", "$table.nguyenquan", "$table.diachithuongtru", "$table.ngaysinh", "$table.cmnd", "$table.sđt", "$table.stk", "$table.);
