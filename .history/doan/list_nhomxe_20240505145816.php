...
if (isset($_GET['filter']))
    if (isset($_GET['from_date']) && isset($_GET['to_date'])) {
        ...
        $table = "tuyenvantai";
        $columns = array("$table.id_$table", "$table.ten", "$table.diemdau", "$table.id_tinhthanhdau", "$table.diemcuoi", "$table.id_tinhthanhcuoi", "$table.culy", "$table.dautieuthu", "$table.ghichu");
        ...
        INNER JOIN nguoidung ON nhomxe.id_nguoitao = nguoidung.id_nguoidung
        LEFT JOIN nguoidung AS nguoidung2 ON nhomxe.id_nguoisua = nguoidung2.id_nguoidung
        WHERE nhomxe.ngaysua BETWEEN '$from_date' AND '$to_date'
        ORDER BY nhomxe.ngaytao DESC
        LIMIT $offset,$total_records_per_page";
                            ...
                            <form class="needs-validation" novalidate action="them_nhomxe.php" method="POST">
                                <div class="form-row">
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <input type="text" class="form-control" name="id_nhomxe"
                                            id="validationCustom01" placeholder="Mã nhóm xe" value="" required>
