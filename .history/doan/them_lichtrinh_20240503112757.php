...
if (isset($_POST['thembtn'])) {
    if (
        ...
        $sql = "INSERT INTO `lichtrinh`( `id_lichtrinh`, `ten`,`id_nhomhanghoa`, `id_nhomhanghoa`, `donvitinh`, 
        `ghichu`, `ngaytao`, `id_nguoitao`) 
        VALUES ('$id_lichtrinh', '$ten','$id_nhomhanghoa','$kichthuoc','$donvitinh','$ghichu', current_timestamp(),'5')";
