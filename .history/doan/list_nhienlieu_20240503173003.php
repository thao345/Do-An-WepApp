...
$sql = "SELECT nhienlieu.id_donviccdau, nhienlieu.ten, nguoidung.tendangnhap AS nguoitao, nguoidung.id_nguoidung, DATE(nhienlieu.ngaytao) as ngaytao, nguoidung2.tendangnhap AS nguoisua, nguoidung2.id_nguoidung, DATE(nhienlieu.ngaysua) as ngaysua
        FROM nhienlieu
...
if (isset($_GET['from_date']) && isset($_GET['to_date'])) {
    ...
    $sql = "SELECT nhienlieu.id_donviccdau, nhienlieu.ten, nguoidung.tendangnhap AS nguoitao, nguoidung.id_nguoidung, DATE(nhienlieu.ngaytao) as ngaytao, nguoidung2.tendangnhap AS nguoisua, nguoidung2.id_nguoidung, DATE(nhienlieu.ngaysua) as ngaysua
            ...
            INNER JOIN nguoidung ON nhienlieu.id_nguoitao = nguoidung.id_nguoidung
            LEFT JOIN nguoidung AS nguoidung2 ON nhienlieu.id_nguoisua = nguoidung2.id_nguoidung
            WHERE nhienlieu.ngaysua BETWEEN '$from_date' AND '$to_date'
            ORDER BY nhienlieu.ngaytao DESC
            LIMIT $offset,$total_records_per_page";
