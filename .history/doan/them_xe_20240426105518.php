...
if (isset($_POST['luubtn'])) {
    ...
    $bienso = $_POST['bienso'];
    $trangthai = $_POST['select_TrangThai'];
    $id_nhomxe = $_POST['select_NX'];
    $tennhomxe = get_name($id_nhomxe, 'nhomxe', 'id_nhomxe');
    $id_nhienlieu = $_POST['select_NL'];
    $id_thauphu = $_POST['select_TP'];
    ...
    $sql = "UPDATE xe
        SET bienso='$bienso', trangthaixe = $trangthai ,id_nhomxe ='$id_nhomxe', id_tinhthanhdau = '$id_tinhthanhdau',diemcuoi = '$diemcuoi',  id_tinhthanhcuoi = '$id_tinhthanhcuoi', 
