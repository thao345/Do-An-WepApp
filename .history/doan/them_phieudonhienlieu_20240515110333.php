...
if (isset($_POST['thembtn'])) {
    if (
        ...
        VALUES ('$select_donhang', '$ngaydonhienlieu','$select_DVCCD','$soluongnhienlieu','$select_NL','$image','$thanhtien','$ghichu', current_timestamp(),'$id_nguoidung')";
...
if (isset($_POST['xoabtn'])) {
    ...
    $sql1 = "UPDATE `phieudonhienlieu` SET `id_nguoisua`='$id_nguoidung' WHERE id_pdnl = '$id_pdnl'";
