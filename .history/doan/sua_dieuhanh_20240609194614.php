                        ...
                        <?php foreach ($resultDieuHanh as $itemsDieuHanh): ?>
                            ...
                            <div class="col-sm-12">
                                <div class="card text-white bg-secondary mb-3 shadow mb-4">
                                    ...
                                    <a href="#collapseCardExampleDieuHanh" class="d-block card-header py-3" data-toggle="collapse" role="button"
                                        aria-expanded="true" aria-controls="collapseCardExampleDieuHanh">
                            ...
                            <div class="col-sm-12 mt-2">
                                <div class="card text-white bg-dieuhanh  mb-3 shadow mb-4">
                                    <!-- Card Header - Accordion -->
                                    <a href="#collapseCardExampleDieuHanh1" class="d-block card-header py-3" data-toggle="collapse" role="button"
                                        aria-expanded="true" aria-controls="collapseCardExampleDieuHanh1">
