...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <div class="input-group">
            <input type="text" class="form-control" id="dongiasauthue_display" 
                   value ="<?php echo number_format($items['dongiasauthue']); ?>" 
                   placeholder="Đơn giá sau thuế" required>
            <input type="hidden" name="dongiasauthue" id="dongiasauthue" value="<?php echo $items['dongiasauthue']; ?>">
            <div class="input-group-append">
    ...
    <script>
        ...
        window.addEventListener('load', function () {
            var hiddenValue = document.getElementById('dongiasauthue').value;
            if (hiddenValue.length > 0) {
                document.getElementById('dongiasauthue_display').value = new Intl.NumberFormat('vi-VN').format(hiddenValue);
            }
        });
    </script>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="date" class="form-control" name="ngayapdung" id="validationCustom02"
                                placeholder="Ngày áp dụng" value="<?php echo $items['ngayapdung']; ?>">
                            <div class="invalid-feedback">
                                Ngày áp dụng.
                            </div>
                        </div>
