...
$sqlCount = "SELECT COUNT(*) as total_rows FROM nhat";
...
$sqlBase = "SELECT nhat.id_nhat, nhat.ten, nguoidung.tendangnhap AS nguoitao, nguoidung.id_nguoidung, DATE(nhat.ngaytao) as ngaytao, nguoidung2.tendangnhap AS nguoisua, nguoidung2.id_nguoidung, DATE(nhat.ngaysua) as ngaysua
            FROM nhat
            INNER JOIN nguoidung ON nhat.id_nguoitao = nguoidung.id_nguoidung
            LEFT JOIN nguoidung AS nguoidung2 ON nhat.id_nguoisua = nguoidung2.id_nguoidung";

$sql = "$sqlBase WHERE 1
        ORDER BY nhat.ngaytao DESC
...
if (isset($_GET['filter'])) {
    if (isset($_GET['from_date']) && isset($_GET['to_date'])) {
        ...
        $sql = "$sqlBase 
                WHERE nhat.ngaytao BETWEEN '$from_date  00:00:00' AND '$to_date 23:59:59'
                ORDER BY nhat.ngaytao DESC
                LIMIT $offset,$total_records_per_page";
...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <div class="d-flex">
                ...
                <form class="form-inline ml-auto mr-4 border p-3 rounded filternhat" method="GET">
                    ...
                    <div class="form-group ml-3">
                        ...
                        <a href="list_nhat.php" class="btn btn-danger">Làm mới</a>
                ...
                <div class="modal-dialog modal-lg modal-dialog-centered  modal-dialog-scrollable">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form class="needs-validation" novalidate action="them_nhat.php" method="POST">
                                <div class="form-row">
                                    <div class="col-md-12 mb-3">
                                        <label for="validationCustom01">Mã tỉnh thành</label>
                                        <input type="text" class="form-control" name="id_nhat"
                    ...
                    <table class=" table table-bordered table-hover " id="myTable" width="100%" cellspacing="0">
                        ...
                        <tbody style=" white-space: nowrap;">
                            ...
                            foreach ($result as $items):
                                ...
                                <tr data-id="<?php echo $items['id_nhat']; ?>">
                                    <td>
                                        <?php echo $count++; ?>
                                    </td>
                                    <td>
                                        <?php echo $items['id_nhat']; ?>
                                    </td>
                                    <td>
                                        <?php echo $items['ten']; ?>
                                    </td>
                                    ...
                                    <td>
                                        <form action="sua_nhat.php" method="POST">
                                            <input type="hidden" name="edit_id"
                                                value="<?php echo $items['id_nhat']; ?>">
                                            <button name="suabtn" class="btn btn-success">Sửa</button>
                                        </form>
                                    </td>
                                    <td>
                                        <!-- Thêm modal dialog -->
                                        <div class="modal" id="deleteModal-<?php echo $items['id_nhat']; ?>"
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <form action="them_nhat.php" method="POST">
                                        ...
                                        <button class="btn btn-danger" data-toggle="modal"
                                            data-target="#deleteModal-<?php echo $items['id_nhat']; ?>">Xoá</button>
                                    </td>
                                </tr>
    ...
    <script>
        ...
        $('tr[data-id]').on('dblclick', function () {
            ...
            window.location.href = 'sua_nhat.php?edit_id=' + id;
        });
