                        ...
                        <div class="modal-body">
                            <form class="needs-validation" novalidate action="them_nhienlieu.php" method="POST">
                                <div class="form-row">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <label for="validationCustom02">Đơn giá sau thuế</label>
                                        <input type="text" class="form-control" name="dongiasauthue" id="validationCustom02"
                                            placeholder="Đơn giá sau thuế" value="" required>
                                        <div class="invalid-feedback">
