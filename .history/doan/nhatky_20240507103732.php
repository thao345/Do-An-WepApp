            ...
            <div class="d-flex">
                ...
                <form class="form-inline ml-auto mr-4 border p-3 rounded filterDonHang " method="GET">
                    <div class="form-group">
                        <input class="form-check-input checkbox-to" type="checkbox" name="filter_nguoi"
                            id="filter_nguoi" value="1" <?php echo isset($_GET['filter_nguoi']) && $_GET['filter_nguoi'] == '1' ? 'checked' : ''; ?>>
                        <div class="input-group ml-3">
                            <div class="input-group-prepend">
                                <span class="input-group-text" id="basic-addon3">Trạng thái</span>
                            </div>
                            <select disabled class="form-control mr-5" name="nguoi" id="exampleFormControlSelect1"
                                aria-describedby="basic-addon3">
                                <option value="">Chọn trạng thái</option>
                                <option value="Hủy" <?php echo isset($_GET['nguoi']) == true ? ($_GET['nguoi'] == 'Hủy' ? 'selected' : '') : ''; ?>>Hủy</option>
                                <option value="Hoàn thành" <?php echo isset($_GET['nguoi']) == true ? ($_GET['nguoi'] == 'Hoàn thành' ? 'selected' : '') : ''; ?>>Hoàn thành</option>
