                ...
                <?php foreach ($result as $items): ?>
                    <div class="form-row">
                        <div class="col-md-12 mb-3">
                            <label for="validationCustom01">Mã xe</label>
                            <input type="text" readonly class="form-control" name="id_edit" id="validationCustom01"
                                placeholder="Mã xe" value="<?php echo $items['id_nhomxe']; ?>" required>
                            <div class="invalid-feedback">
                                Nhập mã xe.
                            </div>
                        </div>
                        <div class="col-md-12 mb-3">
                            <label for="validationCustom02">Tên xe</label>
                            <input type="text" class="form-control" name="ten_edit" id="validationCustom02"
                                placeholder="Tên xe" value="<?php echo $items['ten']; ?>" required>
                            <div class="invalid-feedback">
                                Nhập tên xe.
                            </div>
                        </div>
