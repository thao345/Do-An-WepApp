                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                Bạn có chắc chắn muốn xoá tất cả nhật ký trong tháng ?
                            </div>
                            <div class="modal-footer">
                    ...
                    $(document).ready(function () {
                        ...
                        $('#xoabtn').click(function () {
                            ...
                            if (selectedMonth) {
                                ...
                                $('#confirmDeleteModal-selectedMonth').modal('show');
                            } else {
                        ...
                        $('#confirmDeleteBtn').click(function () {
                            // Thực hiện các hành động xoá ở đây (ví dụ: gửi yêu cầu xoá đến máy chủ)
                            // Sau khi xoá hoàn tất, bạn có thể thực hiện các hành động khác (ví dụ: làm mới trang)
                            // Ở đây, chúng ta chỉ đóng hộp thoại xác nhận
