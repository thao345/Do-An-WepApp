...
if (isset($_POST['thembtn'])) {
    if (
        ...
        $sql = "INSERT INTO nhansu (id_nhansu, ten, tenphongban, chucvu, nguyenquan, diachithuongtru, ngaysinh, cmnd, sđt, stk, tennganhang, id_nguoitao,ngaytao) 
                VALUES ('$idns', '$ten','$tenphongban','$chucvu','$nguyenquan','$diachithuongtru','$ngaysinh','$cmnd','$sđt','$stk','$nganhang','5', current_timestamp())";
...
if (isset($_POST['luubtn'])) {
    ...
    $sql = "UPDATE nhansu
        SET ten = '$ten', tenphongban = '$tenphongban', chucvu = '$chucvu', nguyenquan = '$nguyenquan', diachithuongtru = '$diachithuongtru', ngaysinh = '$ngaysinh', cmnd = '$cmnd', sđt = '$sđt', stk = '$stk', tennganhang = '$nganhang', id_nguoisua = '3', ngaysua = current_timestamp()
...
if (isset($_POST['xoabtn'])) {
    ...
    $sql1 = "UPDATE `nhansu` SET `id_nguoisua`='2' WHERE id_nhansu = '$idns'";
