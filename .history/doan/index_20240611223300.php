...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <p>Total number of visitors: <span id="visitor-count"></span></p>

            <script>
                // Fetch the visitor count from the backend and update the HTML element
                fetch('/visitor_count')
                    .then(response => response.json())
                    .then(data => {
                        document.getElementById('visitor-count').innerText = data.access_log_count;
                    });
            </script>
