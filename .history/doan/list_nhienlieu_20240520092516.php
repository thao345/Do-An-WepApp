...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <div class="input-group">
            <input type="text" class="form-control" name="dongiasauthue" id="dongiasauthue" placeholder="Đơn giá sau thuế" value="" required>
            <div class="input-group-append">
                ...
                e.target.value = new Intl.NumberFormat('vi-VN').format(value);
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="date" class="form-control" name="ngayapdung" id="validationCustom02"
                                            placeholder="Ngày áp dụng" value="" required>
                                        <div class="invalid-feedback">
                                            Ngày áp dụng.
                                        </div>
                                    </div>
