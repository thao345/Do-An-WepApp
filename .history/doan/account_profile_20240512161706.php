                        ...
                        <div class="row">
                            <div class="col-md-8">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="inputName" placeholder="Họ tên" value="Thành dz">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="text-center">
                                    <img alt="Charles Hall" src="img/avatars/illustration-businessman_53876-5856.avif
