                ...
                <?php foreach ($result as $items): ?>
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-12 mb-3">
                            <input type="hidden" readonly class="form-control" name="id_tinhthanhdau_edit" id="validationCustom01"
                                placeholder="Mã tỉnh thành đầu" value="<?php echo $items['id_tinhthanhdau']; ?>" required>
                        </div>
                        <div class="col-md-12 mb-3">
                            <input type="hidden" readonly class="form-control" name="id_tinhthanhcuoi_edit" id="validationCustom01"
                                placeholder="Mã tỉnh thành cuối" value="<?php echo $items['id_tinhthanhcuoi']; ?>" required>
                        </div>
