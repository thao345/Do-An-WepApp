                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="hidden" name="dongiasauthue" id="dongiasauthue" value="">
                                            <div class="input-group-append">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="date" class="form-control" name="ngayapdung"
                                            id="validationCustom02" placeholder="Ngày áp dụng" value="">
                                        <div class="invalid-feedback">
                                            Ngày áp dụng.
                                        </div>
                                    </div>
                ...
                <table class=" table  table-bordered table-hover " id="myTable" width="100%" cellspacing="0">
                        <thead style=" white-space: nowrap;" class="thead-dark">
                            <tr>
                                 ...
                                 <th class="text-center">Mã nhiên liệu</th>
                                 <th class="text-center">Tên</th>
                                 <th class="text-center">Đơn giá sau thuế</th>
                            ...
                            foreach ($result as $items):
                                ...
                                <tr data-id="<?php echo $items['id_nhienlieu']; ?>">
                                    ...
                                    <td>
                                        ...
                                        <input type="hidden" name="edit_id"value="<?php echo $items['id_nhienlieu']; ?>">
                                    ...
                                    <td>
                                        ...
                                        <button class="btn  btn-delete  btn-block" data-toggle="modal"
                                            data-target="#deleteModal-<?php echo $items['id_nhienlieu']; ?>">
