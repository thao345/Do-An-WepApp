...
$sql = "SELECT hanghoa.id_hanghoa, hanghoa.ten, nhomhanghoa.ten AS tennhomhanghoa, hanghoa.kichthuoc, hanghoa.donvitinh, hangh nguoidung.tendangnhap AS nguoitao, nguoidung.id_nguoidung, DATE(hanghoa.ngaytao) as ngaytao, nguoidung2.tendangnhap AS nguoisua, nguoidung2.id_nguoidung, DATE(hanghoa.ngaysua) as ngaysua
        FROM hanghoa
...
if (isset($_GET['from_date']) && isset($_GET['to_date'])) {
    ...
    $sql = "SELECT hanghoa.id_hanghoa, hanghoa.ten, nguoidung.tendangnhap AS nguoitao, nguoidung.id_nguoidung, DATE(hanghoa.ngaytao) as ngaytao, nguoidung2.tendangnhap AS nguoisua, nguoidung2.id_nguoidung, DATE(hanghoa.ngaysua) as ngaysua
            FROM hanghoa
            INNER JOIN nguoidung ON hanghoa.id_nguoitao = nguoidung.id_nguoidung
            LEFT JOIN nguoidung AS nguoidung2 ON hanghoa.id_nguoisua = nguoidung2.id_nguoidung
            WHERE hanghoa.ngaysua BETWEEN '$from_date' AND '$to_date'
            ORDER BY hanghoa.ngaytao DESC
            LIMIT $offset,$total_records_per_page";
    ...
    //         echo "day la timkiem";
    //         echo "ID: " . $row['id_hanghoa'] . "<br>";
    //         echo "Tên nhóm hàng hoá: " . $row['ten'] . "<br>";
