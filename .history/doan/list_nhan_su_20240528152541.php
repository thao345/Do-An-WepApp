                                    ...
                                    <script>
                                        $(document).ready(function () {
                                            ...
                                            $('#ngaysinh').on('change', function () {
                                                ...
                                                if (age < 18) {
                                                    // Người dùng chưa đủ 18 tuổi, hiển thị thông báo lỗi
                                                    $(this).closest('.col-md-4').find('.invalid-feedback').text('Yêu cầu nhân viên đủ 18 tuổi trở lên');
                                                    $(this).addClass('is-invalid');
                                                } else {
                                                    // Người dùng đủ 18 tuổi, xóa thông báo lỗi
