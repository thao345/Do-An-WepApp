    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <div class="d-flex mt-3 mb-3 float-right">
                ...
                <!-- filter ngày -->
                <form class="form-inline ml-auto mr-4 border p-3 rounded filternhansu " method="GET">
                    ...
                    <div class="form-group ml-3">
                        ...
                        <a href="list_nhan_su.php" class="btn btn-danger">Reset</a>
                    </div>
                </form>
            </div>
                        ...
                        <tbody style=" white-space: nowrap;">
                            ...
                            foreach ($result as $items):
                                ...
                                <tr data-id="<?php echo $items['id_nhansu']; ?>">
                                    ...
                                    <td>
                                        <!-- Thêm modal dialog -->
                                        <div class="modal" id="deleteModal-<?php echo $items['id_auto_increment']; ?>" tabindex="-1" role="dialog">
                                        ...
                                        <button class="btn btn-danger" data-toggle="modal"
                                            data-target="#deleteModal-<?php echo $items['id_auto_increment']; ?>">Xoá</button>
                                    </td>
                                </tr>
