...
$sqlCount = "SELECT COUNT(*) as total_rows FROM thauphu";
...
$sql = "SELECT thauphu.id_thauphu, thauphu.ten, thauphu.diachi, thauphu.sodienthoai, thauphu.masothue, nhomhanghoa.ten as tennhomhanghoa, nguoidung.tendangnhap AS nguoitao, nguoidung.id_nguoidung, DATE(thauphu.ngaytao) as ngaytao, nguoidung2.tendangnhap AS nguoisua, nguoidung2.id_nguoidung, DATE(thauphu.ngaysua) as ngaysua
        FROM thauphu
        INNER JOIN nhomhanghoa ON thauphu.id_nhomhanghoa = nhomhanghoa.id_nhomhanghoa
        INNER JOIN nguoidung ON thauphu.id_nguoitao = nguoidung.id_nguoidung
        LEFT JOIN nguoidung AS nguoidung2 ON thauphu.id_nguoisua = nguoidung2.id_nguoidung
        WHERE 1
        ORDER BY thauphu.ngaytao DESC
...
if (isset($_GET['from_date']) && isset($_GET['to_date'])) {
    ...
    $sql = "SELECT thauphu.id_thauphu, thauphu.ten, thauphu.diachi, thauphu.sodienthoai, thauphu.masothue, nhomhanghoa.ten as tennhomhanghoa, nguoidung.tendangnhap AS nguoitao, nguoidung.id_nguoidung, DATE(thauphu.ngaytao) as ngaytao, nguoidung2.tendangnhap AS nguoisua, nguoidung2.id_nguoidung, DATE(thauphu.ngaysua) as ngaysua
            FROM thauphu
            INNER JOIN nhomthauphu ON thauphu.id_nhomthauphu = nhomthauphu.id_nhomthauphu
            INNER JOIN nguoidung ON thauphu.id_nguoitao = nguoidung.id_nguoidung
            LEFT JOIN nguoidung AS nguoidung2 ON thauphu.id_nguoisua = nguoidung2.id_nguoidung
            WHERE thauphu.ngaysua BETWEEN '$from_date' AND '$to_date'
            ORDER BY thauphu.ngaytao DESC
            LIMIT $offset,$total_records_per_page";
    ...
    //         echo "day la timkiem";
    //         echo "ID: " . $row['id_thauphu'] . "<br>";
    //         echo "Tên thầu phụ: " . $row['ten'] . "<br>";
...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <!-- Page Heading -->
            <h1 class="h3 mb-4 text-gray-800  text-center header-crud">Danh sách thầu phụ</h1>
            <!-- Topbar Search -->
            <div class="d-flex">
                ...
                <button type="button" class="btn btn-primary align-self-center" data-toggle="modal"
                    data-target="#exampleModal" data-whatever="@mdo">Thêm thầu phụ</button>

                <form class="form-inline ml-auto mr-4 border p-3 rounded filterthauphu" method="GET">
                ...
                <div class="modal-dialog modal-lg modal-dialog-centered  modal-dialog-scrollable">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form class="needs-validation" novalidate action="them_thauphu.php" method="POST">
                                <div class="form-row">
                                    <div class="col-md-4 mb-3">
                                        <label for="validationCustom01">Mã thầu phụ</label>
                                        <input type="text" class="form-control" name="id_thauphu"
                                            id="validationCustom01" placeholder="Mã thầu phụ" value="" required>
                                        <div class="invalid-feedback">
                                            Nhập mã thầu phụ.
                                        </div>
                                    </div>
                                    <div class="col-md-8 mb-3">
                                        <label for="validationCustom02">Tên thầu phụ</label>
                                        <input type="text" class="form-control" name="ten" id="validationCustom02"
                                            placeholder="Tên thầu phụ" value="" required>
                                        <div class="invalid-feedback">
                                            Nhập tên thầu phụ.
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <input type="text" class="form-control" name="diachi"
                                            id="validationCustom01" placeholder="Địa chỉ" value="" >
                                        <div class="invalid-feedback">
                                            Nhập địa chỉ.
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" class="form-control" name="masothue"
                                            id="validationCustom01" placeholder="Mã số thuế" value="" >
                                        <div class="invalid-feedback">
                                            Nhập mã số thuế.
                                        </div>
                                    </div>
                                    <div class="col-md-4  mb-3">
                                        <label for="validationCustom01">Nhóm thầu phụ</label>
                                        <select name="id_nhomthauphu" class="" id="id_nhomthauphu" required>
                                            <option value="">--Chọn nhóm thầu phụ--</option>
                                            <?php foreach ($resultNTP as $itemsNTP): ?>
                                                <option value="<?php echo $itemsNTP['id_nhomthauphu']; ?>">
                                                    <?php echo $itemsNTP['ten']; ?>
                                                </option>
                                            <?php endforeach ?>
                                        </select>
                                        <div class="invalid-feedback">
                    ...
                    <table class=" table table-bordered table-hover " id="myTable" width="100%" cellspacing="0">
                        ...
                        <tbody style=" white-space: nowrap;">
                            ...
                            foreach ($result as $items):
                                ...
                                <tr data-id="<?php echo $items['id_thauphu']; ?>">
                                    <td>
                                        <?php echo $count++; ?>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <form action="sua_thauphu.php" method="POST">
                                    ...
                                    <td>
                                        <!-- Thêm modal dialog -->
                                        <div class="modal" id="deleteModal-<?php echo $items['id_thauphu']; ?>" tabindex="-1" role="dialog">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <form action="them_thauphu.php" method="POST">
                                        ...
                                        <button class="btn btn-danger" data-toggle="modal"
                                            data-target="#deleteModal-<?php echo $items['id_thauphu']; ?>">Xoá</button>
                                    </td>
                                </tr>
    ...
    <script>
        ...
        $('tr[data-id]').on('dblclick', function () {
            ...
            window.location.href = 'sua_thauphu.php?edit_id=' + id;
        });
