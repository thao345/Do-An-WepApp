                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group ml-3">
                            ...
                            <select disabled class="form-control mr-5" name="nguoithuchien" id="exampleFormControlSelect1"
                                ...
                                <option value="Hủy" <?php echo isset($_GET['nguoithuchien']) == true ? ($_GET['nguoithuchien'] == 'Hủy' ? 'selected' : '') : ''; ?>>Hủy</option>
                                <option value="Hoàn thành" <?php echo isset($_GET['nguoithuchien']) == true ? ($_GET['nguoithuchien'] == 'Hoàn thành' ? 'selected' : '') : ''; ?>>Hoàn thành</option>
