...
if (isset($_POST['luubtn'])) {
    ...
    $sql = "UPDATE nhansu
        SET ten = '$ten', tenphongban = '$tenphongban', chucvu = '$chucvu', nguyenquan = '$nguyenquan', diachithuongtru = '$diachithuongtru', ngaysinh = '$ngaysinh', cmnd = '$cmnd', sđt = '$sđt', stk = '$stk', tennganhang = '$nganhang', id_nguoisua = '$id_nguoidung', ngaysua = current_timestamp()
