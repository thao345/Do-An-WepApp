                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <div class="input-group mb-2">
                                <input type="text" class="form-control" name="sokg_display" id="sokg_display"
                                    placeholder="Nhập số kg..." value="<?php echo $items['sokg']; ?>" required>
                                <input type="hidden" name="sokg" id="sokg" value="<?php echo $items['sokg']; ?>" required>
                        ...
                        <div class="col-md-3 mb-3 ngaydongcontainer">
                            ...
                            <input type="date" class="form-control" name="ngaydongcontainer" id="ngaydongcontainer"
                        ...
                        <!-- <div class="col-md-3 mb-3">
                            ...
                            <div class="input-group mb-2"> -->
                        <input type="hidden" class="form-control" name="giacuoc" id="giacuoc" placeholder="Giá cước"
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div class="input-group mb-2">
                                ...
                                <input type="hidden" name="thuthutuc" id="thuthutuc"
                                    value="<?php echo $items['thuthutuc']; ?>">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div class="input-group mb-2">
                                <input type="text" class="form-control" id="thukhac_display" placeholder="Nhập thu khác..."
                                    value="<?php echo $items['thukhac']; ?>">
                                <input type="hidden" name="thukhac" id="thukhac" value="<?php echo $items['thukhac']; ?>">
                                <div class="input-group-prepend">
                                    <div class="input-group-text rounded-right text-gray-100 bg-gradient-primary">
                                        VNĐ
                                    </div>
