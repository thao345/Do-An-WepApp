            ...
            <div class="d-flex">
                ...
                <form class="form-inline ml-auto mr-4 border p-3 rounded filterDonHang " method="GET">
                    ...
                    <div class="form-group ml-3">
                        ...
                        <a href="list_nguoidung.php" class="btn btn-danger">Reset</a>
                    </div>
                </form>
            </div>
            <script>
                                ...
                                <tr data-id="<?php echo $items['id_nguoidung']; ?>">
                                    ...
                                    <td>
                                        <form action="phanquyen.php" method="POST">
                                            ...
                                            <button name="PhanQuyenbtn" class="btn btn-success pq-button">Phân
                                                quyền</button>
                                        </form>
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        <button class="btn btn-danger" data-toggle="modal"
                                            data-target="#deleteModal-<?php echo $items['id_nguoidung']; ?>">Xoá</button>
                                    </td>
                                </tr>
