...
function filter($table, $columns, $from_date, $to_date, $offset, $total_records_per_page)
{
    ...
    $sql = "SELECT $col, nguoidung.tendangnhap AS nguoitao, nguoidung.id_nguoidung, DATE(hangtau.ngaytao) as ngaytao, nguoidung2.tendangnhap AS nguoisua, nguoidung2.id_nguoidung, DATE(hangtau.ngaysua) as ngaysua
