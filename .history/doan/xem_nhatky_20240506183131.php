                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="text" class="form-control" name="ten_edit" id="validationCustom02"
                                placeholder="Tên " value="<?php echo $items['ten']; ?>" required>
                            <div class="invalid-feedback">
                                Nhập tên .
                            </div>
                        </div>
