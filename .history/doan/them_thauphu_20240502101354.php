...
if (isset($_POST['thembtn'])) {
    if (
        ...
        $sql = "INSERT INTO `hanghoa`( `id_thauphu`, `ten`,`diachi`, `sodienthoai`, `donvitinh`, 
        `ghichu`, `ngaytao`, `id_nguoitao`) 
        VALUES ('$id_thauphu', '$ten','$diachi','$sodienthoai','$donvitinh','$ghichu', current_timestamp(),'5')";
...
if (isset($_POST['luubtn'])) {
    ...
    $sql = "UPDATE hanghoa
        SET ten='$ten', diachi = '$diachi' ,sodienthoai ='$sodienthoai', donvitinh = '$donvitinh',ghichu = '$ghichu', 
