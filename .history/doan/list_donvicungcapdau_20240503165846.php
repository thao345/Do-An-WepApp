...
$sql = "SELECT donvicungcapdau.id_donvic, donvicungcapdau.ten, nguoidung.tendangnhap AS nguoitao, nguoidung.id_nguoidung, DATE(donvicungcapdau.ngaytao) as ngaytao, nguoidung2.tendangnhap AS nguoisua, nguoidung2.id_nguoidung, DATE(donvicungcapdau.ngaysua) as ngaysua
                            ...
                            <form class="needs-validation" novalidate action="them_donvicungcapdau.php" method="POST">
                                <div class="form-row">
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <input type="text" class="form-control" name="id_donvic"
                    ...
                    <table class=" table table-bordered table-hover " id="myTable" width="100%" cellspacing="0">
                        ...
                        <tbody style=" white-space: nowrap;">
                            ...
                            foreach ($result as $items):
                                ...
                                <tr data-id="<?php echo $items['id_donvic']; ?>">
                                    <td>
                                        <?php echo $count++; ?>
                                    </td>
                                    <td>
                                        <?php echo $items['id_donvic']; ?>
                                    </td>
                                    <td>
                                        <?php echo $items['ten']; ?>
                                    </td>
                                    ...
                                    <td>
                                        <form action="sua_donvicungcapdau.php" method="POST">
                                            <input type="hidden" name="edit_id"
                                                value="<?php echo $items['id_donvic']; ?>">
                                            <button name="suabtn" class="btn btn-success">Sửa</button>
                                        </form>
                                    </td>
                                    <td>
                                        <!-- Thêm modal dialog -->
                                        <div class="modal" id="deleteModal-<?php echo $items['id_donvic']; ?>" tabindex="-1" role="dialog">
                                        ...
                                        <button class="btn btn-danger" data-toggle="modal"
                                            data-target="#deleteModal-<?php echo $items['id_donvic']; ?>">Xoá</button>
                                    </td>
                                </tr>
