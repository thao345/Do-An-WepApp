...
$sql = "SELECT lichtrinh.id_lichtrinh, lichtrinh.ten, lichtrinh.loaihang, lichtrinh.sodienthoai, lichtrinh.masothue, nhomhanghoa.ten as tennhomhanghoa, nguoidung.tendangnhap AS nguoitao, nguoidung.id_nguoidung, DATE(lichtrinh.ngaytao) as ngaytao, nguoidung2.tendangnhap AS nguoisua, nguoidung2.id_nguoidung, DATE(lichtrinh.ngaysua) as ngaysua
        FROM lichtrinh
...
if (isset($_GET['from_date']) && isset($_GET['to_date'])) {
    ...
    $sql = "SELECT lichtrinh.id_lichtrinh, lichtrinh.ten, lichtrinh.diachi, lichtrinh.sodienthoai, lichtrinh.masothue, nhomhanghoa.ten as tennhomhanghoa, nguoidung.tendangnhap AS nguoitao, nguoidung.id_nguoidung, DATE(lichtrinh.ngaytao) as ngaytao, nguoidung2.tendangnhap AS nguoisua, nguoidung2.id_nguoidung, DATE(lichtrinh.ngaysua) as ngaysua
            FROM lichtrinh
            INNER JOIN nhomlichtrinh ON lichtrinh.id_nhomlichtrinh = nhomlichtrinh.id_nhomlichtrinh
            INNER JOIN nguoidung ON lichtrinh.id_nguoitao = nguoidung.id_nguoidung
            LEFT JOIN nguoidung AS nguoidung2 ON lichtrinh.id_nguoisua = nguoidung2.id_nguoidung
                        ...
                        <tbody style=" white-space: nowrap;">
                            ...
                            foreach ($result as $items):
                                ...
                                <tr data-id="<?php echo $items['id_lichtrinh']; ?>">
                                    ...
                                    <td>
                                        <!-- Thêm modal dialog -->
                                        <div class="modal" id="deleteModal-<?php echo $items['id_lichtrinh']; ?>" tabindex="-1" role="dialog">
