...
$sql = "SELECT khachhang.id_khachhang, khachhang.ten, khachhang.diachi, khachhang.sodienthoai, khachhang.masothue, nhomhanghoa.ten as tennhomhanghoa, nguoidung.tendangnhap AS nguoitao, nguoidung.id_nguoidung, DATE(khachhang.ngaytao) as ngaytao, nguoidung2.tendangnhap AS nguoisua, nguoidung2.id_nguoidung, DATE(khachhang.ngaysua) as ngaysua
        FROM khachhang
        INNER JOIN nhomhanghoa ON khachhang.id_nhomhanghoa = nhomhanghoa.id_nhomhanghoa
...
if (isset($_GET['from_date']) && isset($_GET['to_date'])) {
    ...
    $sql = "SELECT khachhang.id_khachhang, khachhang.ten, khachhang.diachi, khachhang.sodienthoai, khachhang.masothue, nhomhanghoa.ten as tennhomhanghoa, nguoidung.tendangnhap AS nguoitao, nguoidung.id_nguoidung, DATE(khachhang.ngaytao) as ngaytao, nguoidung2.tendangnhap AS nguoisua, nguoidung2.id_nguoidung, DATE(khachhang.ngaysua) as ngaysua
            FROM khachhang
            INNER JOIN nhomkhachhang ON khachhang.id_nhomkhachhang = nhomkhachhang.id_nhomkhachhang
            INNER JOIN nguoidung ON khachhang.id_nguoitao = nguoidung.id_nguoidung
            LEFT JOIN nguoidung AS nguoidung2 ON khachhang.id_nguoisua = nguoidung2.id_nguoidung
