                                    ...
                                    <script>
                                        $(document).ready(function () {
                                            ...
                                            $('#ngaysinh').on('change', function () {
                                                ...
                                                if (ngaysinh > ngayCatMang) {
                                                    // Ngày đóng container lớn hơn ngày cắt máng, hiển thị thông báo lỗi
                                                    $(this).closest('.ngaysinh').find('.invalid-feedback').text('Yêu cầu nhân viên đủ 18 tuổi trở lên');
                                                   
                                                    $(this).addClass('is-invalid');
                                                } else {
                                                    // Ngày đóng container hợp lệ, xóa thông báo lỗi
                                                    $(this).closest('.ngaysinh').find('.invalid-feedback').text('');
