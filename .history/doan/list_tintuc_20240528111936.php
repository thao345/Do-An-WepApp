                ...
                <table class=" table  table-bordered table-hover " id="myTable" width="100%" cellspacing="0">
                        ...
                        <tbody style=" white-space: nowrap;">
                            ...
                            foreach ($result as $items):
                                ...
                                <tr  <th class="text-center"></th> data-id="<?php echo $items['id_tintuc']; ?>">
                                    <td>
                                        <?php echo $count++; ?>
                                    </td>
                                    ...
                                    <td>
                                        <a href="../website_gt/images/<?php echo $items['img']; ?>" target="_blank">
                                            <img style="width: 100px;"
                                                src="../website_gt/images/<?php echo $items['img']; ?>?>">
                                        </a>
                                    </td>
