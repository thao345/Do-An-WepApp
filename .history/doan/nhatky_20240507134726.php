    ...
    <div id="content">
        ...
        <div class="container-fluid">
                ...
                <form class="form-inline ml-auto mr-4 border p-3 rounded filterDonHang " method="GET">
                    <div class="form-group">
                        <input class="form-check-input checkbox-to" type="checkbox" name="filter_nguoithuchien"
                            id="filter_nguoithuchien" value="1" <?php echo isset($_GET['filter_nguoithuchien']) && $_GET['filter_nguoithuchien'] == '1' ? 'checked' : ''; ?>>
                        <div class="input-group ml-3">
                            <div class="input-group-prepend">
                                <span class="input-group-text" id="basic-addon3">Trạng thái</span>
                            </div>
                            <select disabled class="form-control mr-5" name="nguoithuchien" id="exampleFormControlSelect1"
                                aria-describedby="basic-addon3">
                                <option value="">Người thực hiện</option>
                                <?php foreach ($resultND as $itemsND): ?>
                                                <option value="<?php echo $itemsND['id_nguoidung']; ?>" <?php echo isset($_GET['nguoithuchien']) ? ($_GET['nguoithuchien'] == $itemsND['ten'] ? 'selected' : '') : ''; ?> required>
                                                    <?php echo $itemsND['ten']; ?>
                                                </option>
                                            <?php endforeach ?>
                            </select>
                        </div>
            ...
            <script>
                ...
                const nguoiSelect = document.getElementById('exampleFormControlSelect1');
                ...
                function toggleInputDisabledState() {
                    nguoiSelect.disabled = !filter_nguoithuchien.checked;
                ...
                if (form) {
                    form.addEventListener('submit', function (e) {
                        if (filter_nguoithuchien.checked && nguoiSelect.disabled) {
                            e.preventDefault();
                        }
                                                ...
                                                <div class="modal-content" style="overflow-y: auto;">
                                                    <div class="modal-header header-crud">
                                                        <h1 class="modal-title flex-grow-1 text-gray-800 header-crud"
                                                            id="exampleModalLabel">Chi tiết nhật ký số <?php echo $items['id_nhatky'] ?></h1>
