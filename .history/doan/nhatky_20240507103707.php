            ...
            <div class="d-flex">
                ...
                <form class="form-inline ml-auto mr-4 border p-3 rounded filterDonHang " method="GET">
                    <div class="form-group">
                        <input class="form-check-input checkbox-to" type="checkbox" name="filter_nguoidung"
                            id="filter_nguoidung" value="1" <?php echo isset($_GET['filter_nguoidung']) && $_GET['filter_nguoidung'] == '1' ? 'checked' : ''; ?>>
                        <div class="input-group ml-3">
                            <div class="input-group-prepend">
                                <span class="input-group-text" id="basic-addon3">Trạng thái</span>
                            </div>
                            <select disabled class="form-control mr-5" name="nguoidung" id="exampleFormControlSelect1"
                                aria-describedby="basic-addon3">
                                <option value="">Chọn trạng thái</option>
                                <option value="Hủy" <?php echo isset($_GET['nguoidung']) == true ? ($_GET['nguoidung'] == 'Hủy' ? 'selected' : '') : ''; ?>>Hủy</option>
                                <option value="Hoàn thành" <?php echo isset($_GET['nguoidung']) == true ? ($_GET['nguoidung'] == 'Hoàn thành' ? 'selected' : '') : ''; ?>>Hoàn thành</option>
