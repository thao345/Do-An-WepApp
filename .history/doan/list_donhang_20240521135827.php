            ...
            <div class="table-responsive">
                ...
                <td>
                    ...
                    <button class="btn  btn-delete  btn-block" data-toggle="modal"
                        data-target="#deleteModal<?php echo $items['id_donhang']; ?>" <?php echo $disableXoa; ?>><i class="fas fa-trash"></i> </button>
                </td>
    ...
    <div class="modal fade" id="modalTamUng" tabindex="-1" aria-labelledby="modalTamUngLabel" aria-hidden="true">
        ...
        <div class="modal-dialog modal-xl modal-dialog-centered  modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="needs-validation" novalidate action="them_tamung.php" method="POST" enctype="multipart/form-data">
                        <div class="form-row">
                            <div class="col-sm-12">
