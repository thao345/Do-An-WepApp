...
if (isset($_POST['suabtn'])) {
    $idtt = $_POST['edit_id'];
    $sql = "SELECT * FROM `hanghoa` WHERE id_hanghoa ='$idtt'";
...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <!-- Page Heading -->
            <h1 class="h3 mb-4 text-gray-800  text-center header-crud">Sửa hàng hoá</h1>
            ...
            <form class="needs-validation" novalidate action="them_hanghoa.php" method="POST">
                    ...
                    <div class="form-row">
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" class="form-control" name="id_hanghoa"
                                            id="validationCustom01" placeholder="Mã hàng hoá" value="<?php echo $items['id_hanghoa']?>" required readonly>
                                    ...
                                    <div class="col-md-8 mb-3">
                                        ...
                                        <input type="text" class="form-control" name="ten" id="validationCustom02"
                                            placeholder="Tên hàng hoá" value="<?php echo $items['ten']?>" required>
                                        <div class="invalid-feedback">
                                            Nhập tên hàng hoá.
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" class="form-control" name="kichthuoc"
                                            id="validationCustom01" placeholder="Kích thước" value="<?php echo $items['kichthuoc']?>" >
                                        <div class="invalid-feedback">
                                            Nhập kích thước.
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" class="form-control" name="donvitinh"
                                            id="validationCustom01" placeholder="Đơn vị tính" value="<?php echo $items['donvitinh']?>" >
                                        <div class="invalid-feedback">
                                            Nhập đơn vị tính.
                                        </div>
                                    </div>
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <input type="text" class="form-control" name="ghichu"
                                            id="validationCustom01" placeholder="Ghi chú" value="<?php echo $items['ghichu']?>" >
                                        <div class="invalid-feedback">
                                            Ghi chú.
                                        </div>
                                    </div>
                ...
                <div class="modal-footer">
                    <a href="list_hanghoa.php" class="btn btn-secondary mr-3">Trở lại </a>
