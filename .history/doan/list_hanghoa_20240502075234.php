...
$sql = "SELECT hanghoa.id_hanghoa, hanghoa.ten, nhomhanghoa. nguoidung.tendangnhap AS nguoitao, nguoidung.id_nguoidung, DATE(hanghoa.ngaytao) as ngaytao, nguoidung2.tendangnhap AS nguoisua, nguoidung2.id_nguoidung, DATE(hanghoa.ngaysua) as ngaysua
        FROM hanghoa
