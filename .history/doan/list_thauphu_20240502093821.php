...
$sqlCount = "SELECT COUNT(*) as total_rows FROM thau";
...
$sql = "SELECT thau.id_thau, thau.ten, nhomthau.ten AS tennhomthau, thau.kichthuoc, thau.donvitinh, thau.ghichu, nguoidung.tendangnhap AS nguoitao, nguoidung.id_nguoidung, DATE(thau.ngaytao) as ngaytao, nguoidung2.tendangnhap AS nguoisua, nguoidung2.id_nguoidung, DATE(thau.ngaysua) as ngaysua
        FROM thau
        INNER JOIN nhomthau ON thau.id_nhomthau = nhomthau.id_nhomthau
        INNER JOIN nguoidung ON thau.id_nguoitao = nguoidung.id_nguoidung
        LEFT JOIN nguoidung AS nguoidung2 ON thau.id_nguoisua = nguoidung2.id_nguoidung
        WHERE 1
        ORDER BY thau.ngaytao DESC
...
$sqlnhomthau = "SELECT * FROM nhomthau";
$stmt1 = $conn->prepare($sqlnhomthau);
$query = $stmt1->execute();
$resultnhomthau = array();
...
if (isset($_GET['from_date']) && isset($_GET['to_date'])) {
    ...
    $sql = "SELECT thau.id_thau, thau.ten, nhomthau.ten AS tennhomthau, thau.kichthuoc, thau.donvitinh, thau.ghichu, nguoidung.tendangnhap AS nguoitao, nguoidung.id_nguoidung, DATE(thau.ngaytao) as ngaytao, nguoidung2.tendangnhap AS nguoisua, nguoidung2.id_nguoidung, DATE(thau.ngaysua) as ngaysua
            ...
            INNER JOIN nguoidung ON thau.id_nguoitao = nguoidung.id_nguoidung
            LEFT JOIN nguoidung AS nguoidung2 ON thau.id_nguoisua = nguoidung2.id_nguoidung
            WHERE thau.ngaysua BETWEEN '$from_date' AND '$to_date'
            ORDER BY thau.ngaytao DESC
            LIMIT $offset,$total_records_per_page";
...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <div class="d-flex">
                ...
                <form class="form-inline ml-auto mr-4 border p-3 rounded filterthau" method="GET">
                ...
                <div class="modal-dialog modal-lg modal-dialog-centered  modal-dialog-scrollable">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form class="needs-validation" novalidate action="them_thau.php" method="POST">
                                <div class="form-row">
                                    <div class="col-md-4 mb-3">
                                        <label for="validationCustom01">Mã hàng hoá</label>
                                        <input type="text" class="form-control" name="id_thau"
                                    ...
                                    <div class="col-md-4  mb-3">
                                        ...
                                        <select name="id_nhomthau" class="" id="id_nhomthau" required>
                                            <option value="">--Chọn nhóm hàng hoá--</option>
                                            <?php foreach ($resultNHH as $itemsNHH): ?>
                                                <option value="<?php echo $itemsNHH['id_nhomthau']; ?>">
                    ...
                    <table class=" table table-bordered table-hover " id="myTable" width="100%" cellspacing="0">
                        ...
                        <tbody style=" white-space: nowrap;">
                            ...
                            foreach ($result as $items):
                                ...
                                <tr data-id="<?php echo $items['id_thau']; ?>">
                                    <td>
                                        <?php echo $count++; ?>
                                    </td>
                                    <td>
                                        <?php echo $items['id_thau']; ?>
                                    </td>
                                    <td>
                                        <?php echo $items['ten']; ?>
                                    </td>
                                    <td>
                                        <?php echo $items['tennhomthau']; ?>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <form action="sua_thau.php" method="POST">
                                            <input type="hidden" name="edit_id"
                                                value="<?php echo $items['id_thau']; ?>">
                                            <button name="suabtn" class="btn btn-success">Sửa</button>
                                        </form>
                                    </td>
                                    <td>
                                        <!-- Thêm modal dialog -->
                                        <div class="modal" id="deleteModal-<?php echo $items['id_thau']; ?>" tabindex="-1" role="dialog">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <form action="them_thau.php" method="POST">
                                        ...
                                        <button class="btn btn-danger" data-toggle="modal"
                                            data-target="#deleteModal-<?php echo $items['id_thau']; ?>">Xoá</button>
                                    </td>
                                </tr>
    ...
    <script>
        ...
        $('tr[data-id]').on('dblclick', function () {
            ...
            window.location.href = 'sua_thau.php?edit_id=' + id;
        });
