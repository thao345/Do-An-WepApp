...
<body>
    ...
    <div class="bg-dark text-light" style="float: right;  border-top-left-radius: 10px; border-top-right-radius: 10px; " >
        <div class>
        <p class="ml-3 mt-2" style="float: right; margin-right: 10px;"><i class="fa-solid fa-eye"></i> Online: <span id="current_visitors"></span> </p>
        <p  class=" mt-2" style="float: right; margin-right: 15px;"><i class="fa-solid fa-globe"></i> Truy cập: <span id="total_visitors"></span></p>
        </div>
    </div>
    ...
    <div class="container-fluid bg-dark text-light footer pt-5 wow fadeIn" data-wow-delay="0.1s"
        style="margin-top: 37px;border-bottom-left-radius: 10px; border-bottom-right-radius: 10px;">
