...
<body>
    ...
    <div >
        <p style="float: right"><i class="fa-solid fa-eye"></i> Online: <span id="current_visitors"></span> </p>
        <p class="mr-3"  style="float: right"><i class="fa-solid fa-globe"></i> Truy cập: <span id="total_visitors"></span></p>
    </div>
