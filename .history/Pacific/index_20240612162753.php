...
<body>
    ...
    <div >
        <p class="ml-3" style="float: right; margin-right: 18px;"><i class="fa-solid fa-eye"></i> Online: <span id="current_visitors"></span> </p>
        <p  style="float: right"><i class="fa-solid fa-globe"></i> Truy cập: <span id="total_visitors"></span></p>
    </div>
