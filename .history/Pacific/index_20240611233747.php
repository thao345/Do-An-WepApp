...
<body>
                    ...
                    <div class="row g-4 align-items-center">
                        <div class="col-sm-6">
                            <div class="bg-primary p-4 mb-4 wow fadeIn" data-wow-delay="0.3s">
                                ...
                                <h2 class="text-white mb-2" data-toggle="counter-up"><?php echo $resultkh['so_luong_khach']  ?></h2>
                                <p class="text-white mb-0">Khách hàng</p>
                            </div>
                            <div class="bg-secondary p-4 wow fadeIn" data-wow-delay="0.5s">
                                <i class="fa fa-ship fa-2x text-white mb-3"></i>
                                <h2 class="text-white mb-2" data-toggle="counter-up"><?php echo $resultpt['tong_don_hang'] ; ?></h2>
                        ...
                        <div class="col-sm-6">
                            <div class="bg-success p-4 wow fadeIn" data-wow-delay="0.7s">
                                ...
                                <h2 class="text-white mb-2" data-toggle="counter-up"><?php echo $resultxe['so_xe'] ?></h2>
    ...
    <p>Số lượng người đang truy cập: <span id="current_visitors"></span></p>
    <p>Tổng số người đã truy cập: <span id="total_visitors"></span></p>
    </div>
