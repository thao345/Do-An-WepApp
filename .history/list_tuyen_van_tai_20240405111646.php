...
$sql = "SELECT tuyenvantai.id_tuyenvantai,tuyenvantai.ten,tuyenvantai.ngaytao, nguoidung.tendangnhap AS nguoitao, nguoidung.id_nguoidung, DATE(tuyenvantai.ngaytao) as ngaytao, nguoidung2.tendangnhap AS nguoisua, nguoidung2.id_nguoidung, DATE(tuyenvantai.ngaysua) as ngaysua
