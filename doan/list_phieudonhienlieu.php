...
WHERE 1   AND phieudonhienlieu.ngaydonhienlieu >= DATE_FORMAT(NOW(), '%Y-%m-01')
        AND phieudonhienlieu.ngaydonhienlieu < DATE_FORMAT(NOW() + INTERVAL 1 MONTH, '%Y-%m-01')
...
// mặc định chỉ cho thêm phiếu dầu cho đơn hàng tháng hiện tại và k bị hủy
$sqlDonhang = "SELECT * FROM donhang WHERE ngaytao >= DATE_FORMAT(NOW(), '%Y-%m-01') AND 
ngaytao < DATE_FORMAT(NOW() + INTERVAL 1 MONTH, '%Y-%m-01') AND donhang.trangthai != 'Hủy' ORDER BY id_donhang DESC"; // 2024-04-01 -> 2024-05-01
...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <div class="d-flex">
                ...
                <form class="form-inline ml-auto mr-4 border p-3 rounded filterPDNL " method="GET">
                    ...
                    <div class="form-group ml-3">
                        ...
                        <a href="list_phieudonhienlieu.php" class="btn btn-danger">Làm mới</a>
                        ...
                        <div class="modal-body">
                            <form class="needs-validation" novalidate action="them_phieudonhienlieu.php" method="POST"
                                ...
                                <div class="form-row">
                                    ...
                                    <!-- select search -->
                                    <script>
                                      var select_NL=  new TomSelect("#select_NL", {
                                            create: false,
                                            sortField: {
                                                field: "text",
                                                direction: "desc"
                                        ...
                                        $(document).ready(function () {
                                            $('#select_donhang').change(function () {
                                                ...
                                                select_NL.clear();
                                                // select_NL.clearOptions();
                                                select_NL.refreshOptions();
                                                $.ajax({
            ...
            <div class="col-md-12 head ml-2 mb-2" style="display: flex;">
                <!-- <div>
                    <a href="export_excel.php" class="btn btn-success mr-2" style="min-width: 90px;"><i
                            class="fas fa-download mr-2"></i>Excel</a>
                </div>
                <div>
                    <a href="export_pdf.php" class="btn btn-success mr-2" style="min-width: 90px;"><i
                                ...
                                <tr data-id="<?php echo $items['id_pdnl']; ?>"
                                    ...
                                    <td>
                                        <a href="img/<?php echo $items['anh1']; ?>" target="_blank">
                                            <img style="width: 100px;height:40px;" src="img/<?php echo $items['anh1']; ?>">
                                        </a>
                                    </td>
                                    ...
                                    <!-- check enabled/disabled nút sửa,xóa -->
                                    <?php
                                    ...
                                    <td>
                                        <form action="phieucapdau.php" method="POST" target="_blank">
                                            <input type="hidden" name="id_xe" value="<?php echo $items['id_xe']; ?>">
                                            <input type="hidden" name="id_pdnl" value="<?php echo $items['id_pdnl']; ?>">
                                    ...
                                    <script>
                                        window.addEventListener('DOMContentLoaded', function () {
                                            ...
                                            for (var i = 0; i < printButtons.length; i++) {
                                                var id_pdnl = printButtons[i].form.elements['id_pdnl'].value;
                                                var id_xe = printButtons[i].form.elements['id_xe'].value;

                                                if (id_pdnl === '' || id_pdnl === undefined || id_xe ==='' || id_xe === undefined) {
                                    ...
                                    <td>
                                        ...
                                        <button class="btn  btn-delete btn-block" data-toggle="modal"
                                            data-target="#deleteModal<?php echo $items['id_pdnl']; ?>" <?php echo $disableXoa; ?>><i class="fas fa-trash"></i> </button>
                                    </td>
                                </tr>
            ...
            <div id="printModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="printModalLabel"
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <p>Chưa điều xe cho đơn hàng, không thể in phiếu dầu.</p>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Đóng</button>
                        </div>
