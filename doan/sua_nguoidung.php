        ...
        <div class="container-fluid">
            ...
            <form class="needs-validation" novalidate action="them_nguoidung.php" method="POST">
                <?php foreach ($result as $items): ?>
                    <div class="form-row">
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input type="hidden" class="form-control" name="id_nguoidung"
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <option value="">--Admin--</option>
                                                ...
                                                foreach ($options as $selectisadmin): ?>
                                                    <option value="<?php echo $selectisadmin; ?>" <?php echo ($selectisadmin == $items['isadmin']) ? 'selected' : ''; ?>>
                                                        <?php echo $selectisadmin; ?>
                                                    </option>
                                                <?php endforeach ?>
                                            </select>
                                            <div class="invalid-feedback">
                ...
                <div class="modal-footer">
                    <a href="list_nguoidung.php" class="btn btn-secondary mr-3">Trở lại </a>
