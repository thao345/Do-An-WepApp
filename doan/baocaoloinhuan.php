...
phieudonhienlieu.soluongnhienlieu,sums1.soluongnhienlieu_sum,phieudonhienlieu.thanhtien AS tiennhienlieu,sums1.tiennhienlieu_sum,
 (COALESCE( chitietdonhangtamung.tiencuocvo, 0)) as tiencuocvo ,  
 (COALESCE(sums2.tiencuocvo_sum, 0)) as tiencuocvo_sum ,
  (COALESCE(  chitietdonhangtamung.tienhaiquan, 0)) as tienhaiquan ,  
 (COALESCE(sums2.tienhaiquan_sum, 0)) as tienhaiquan_sum ,
   (COALESCE(  chitietdonhangtamung.tiennangha, 0)) as tiennangha ,  
 (COALESCE(sums2.tiennangha_sum, 0)) as tiennangha_sum ,
    (COALESCE(  chitietdonhangtamung.tienkhac, 0)) as tienkhac ,  
 (COALESCE(sums2.tienkhac_sum, 0)) as tienkhac_sum ,
chiphivantai.phicauduong,sums3.phicauduong_sum,
...
( phieudonhienlieu.thanhtien +   COALESCE(chitietdonhangtamung.tiencuocvo, 0)  + COALESCE(chitietdonhangtamung.tienhaiquan , 0) +  COALESCE(chitietdonhangtamung.tiennangha , 0)  + COALESCE( chitietdonhangtamung.tienkhac, 0)  + chiphivantai.phicauduong + chiphivantai.tienanca + chiphivantai.luongchuyen + chiphivantai.luongchunhat +chiphivantai.tienthuexengoai ) AS tongchi,
sums.tongchi_sum AS tongchi_sum,

((donhang.thuthutuc + donhang.thukhac + chiphivantai.tongchiphi) - phieudonhienlieu.thanhtien - COALESCE(chitietdonhangtamung.tiencuocvo, 0) -  COALESCE(chitietdonhangtamung.tienhaiquan , 0) -  COALESCE(chitietdonhangtamung.tiennangha , 0) - COALESCE( chitietdonhangtamung.tienkhac, 0) - chiphivantai.phicauduong - chiphivantai.tienanca - chiphivantai.luongchuyen - chiphivantai.luongchunhat -chiphivantai.tienthuexengoai) AS loinhuan,
(sums.loinhuan_sum ) as  loinhuan_sum,

 ((1.3/100) * ((donhang.thuthutuc + donhang.thukhac + chiphivantai.tongchiphi) - phieudonhienlieu.thanhtien - COALESCE(chitietdonhangtamung.tiencuocvo, 0) -  COALESCE(chitietdonhangtamung.tienhaiquan , 0) -  COALESCE(chitietdonhangtamung.tiennangha , 0) - COALESCE( chitietdonhangtamung.tienkhac, 0) - chiphivantai.phicauduong - chiphivantai.tienanca - chiphivantai.luongchuyen - chiphivantai.luongchunhat - chiphivantai.tienthuexengoai)) AS '1.3% lợi nhuận',
  sums.1_3_loinhuan_sum,
 
(((donhang.thuthutuc + donhang.thukhac + chiphivantai.tongchiphi) - phieudonhienlieu.thanhtien - COALESCE(chitietdonhangtamung.tiencuocvo, 0) -  COALESCE(chitietdonhangtamung.tienhaiquan , 0) -  COALESCE(chitietdonhangtamung.tiennangha , 0) - COALESCE( chitietdonhangtamung.tienkhac, 0) - chiphivantai.phicauduong - chiphivantai.tienanca - chiphivantai.luongchuyen - chiphivantai.luongchunhat -chiphivantai.tienthuexengoai)-((1.3/100) * ((donhang.thuthutuc + donhang.thukhac + chiphivantai.tongchiphi) - phieudonhienlieu.thanhtien - COALESCE(chitietdonhangtamung.tiencuocvo, 0) -  COALESCE(chitietdonhangtamung.tienhaiquan , 0) -  COALESCE(chitietdonhangtamung.tiennangha , 0) - COALESCE( chitietdonhangtamung.tienkhac, 0) - chiphivantai.phicauduong - chiphivantai.tienanca - chiphivantai.luongchuyen - chiphivantai.luongchunhat - chiphivantai.tienthuexengoai))) as loinhuanthuc,
...
LEFT JOIN tuyenvantai ON tuyenvantai.id_tuyenvantai = donhang.id_tuyenvantai
...
CROSS JOIN (
    SELECT
        ...
        SUM( phieudonhienlieu.thanhtien + COALESCE(chitietdonhangtamung.tiencuocvo, 0)  + COALESCE( chitietdonhangtamung.tienhaiquan, 0)  +  COALESCE( chitietdonhangtamung.tiennangha, 0)  + COALESCE( chitietdonhangtamung.tienkhac, 0) + chiphivantai.phicauduong + chiphivantai.tienanca + chiphivantai.luongchuyen + chiphivantai.luongchunhat +chiphivantai.tienthuexengoai ) AS tongchi_sum,
        SUM((donhang.thuthutuc + donhang.thukhac + chiphivantai.tongchiphi) - phieudonhienlieu.thanhtien - COALESCE(chitietdonhangtamung.tiencuocvo, 0) -  COALESCE(chitietdonhangtamung.tienhaiquan , 0) -  COALESCE(chitietdonhangtamung.tiennangha , 0) - COALESCE( chitietdonhangtamung.tienkhac, 0) - chiphivantai.phicauduong - chiphivantai.tienanca - chiphivantai.luongchuyen - chiphivantai.luongchunhat -chiphivantai.tienthuexengoai) AS loinhuan_sum,
        SUM((1.3/100) * ((donhang.thuthutuc + donhang.thukhac + chiphivantai.tongchiphi) - phieudonhienlieu.thanhtien - COALESCE(chitietdonhangtamung.tiencuocvo, 0) -  COALESCE(chitietdonhangtamung.tienhaiquan , 0) -  COALESCE(chitietdonhangtamung.tiennangha , 0) - COALESCE( chitietdonhangtamung.tienkhac, 0) - chiphivantai.phicauduong - chiphivantai.tienanca - chiphivantai.luongchuyen - chiphivantai.luongchunhat - chiphivantai.tienthuexengoai)) AS 1_3_loinhuan_sum,
        SUM(((donhang.thuthutuc + donhang.thukhac + chiphivantai.tongchiphi) - phieudonhienlieu.thanhtien - COALESCE(chitietdonhangtamung.tiencuocvo, 0) -  COALESCE(chitietdonhangtamung.tienhaiquan , 0) -  COALESCE(chitietdonhangtamung.tiennangha , 0) - COALESCE( chitietdonhangtamung.tienkhac, 0) - chiphivantai.phicauduong - chiphivantai.tienanca - chiphivantai.luongchuyen - chiphivantai.luongchunhat -chiphivantai.tienthuexengoai)-((1.3/100) * ((donhang.thuthutuc + donhang.thukhac + chiphivantai.tongchiphi) - phieudonhienlieu.thanhtien - COALESCE(chitietdonhangtamung.tiencuocvo, 0) -  COALESCE(chitietdonhangtamung.tienhaiquan , 0) -  COALESCE(chitietdonhangtamung.tiennangha , 0) - COALESCE( chitietdonhangtamung.tienkhac, 0) - chiphivantai.phicauduong - chiphivantai.tienanca - chiphivantai.luongchuyen - chiphivantai.luongchunhat - chiphivantai.tienthuexengoai))) as loinhuanthuc_sum
    FROM
        donhang
    LEFT JOIN chiphivantai on chiphivantai.id_donhang = donhang.id_donhang
    LEFT JOIN phieudonhienlieu ON phieudonhienlieu.id_donhang = donhang.id_donhang
...
CROSS JOIN (
    ...
    FROM
       phieudonhienlieu
    LEFT JOIN donhang ON phieudonhienlieu.id_donhang = donhang.id_donhang
    WHERE
        donhang.trangthai = 'Hoàn thành'
        AND donhang.ngaytao >= DATE_FORMAT(NOW(), '%Y-%m-01')
        AND donhang.ngaytao < DATE_FORMAT(NOW() + INTERVAL 1 MONTH, '%Y-%m-01')
...
CROSS JOIN (
    SELECT
        SUM(COALESCE( chitietdonhangtamung.tiencuocvo, 0)) AS tiencuocvo_sum,
        SUM(COALESCE( chitietdonhangtamung.tienhaiquan, 0)) AS tienhaiquan_sum,
        SUM(COALESCE( chitietdonhangtamung.tiennangha, 0)) AS tiennangha_sum,
        SUM(COALESCE( chitietdonhangtamung.tienkhac, 0)) AS tienkhac_sum
    FROM
        chitietdonhangtamung
    LEFT JOIN donhang ON chitietdonhangtamung.id_donhang = donhang.id_donhang
    WHERE
        donhang.trangthai = 'Hoàn thành'
        AND donhang.ngaytao >= DATE_FORMAT(NOW(), '%Y-%m-01')
        AND donhang.ngaytao < DATE_FORMAT(NOW() + INTERVAL 1 MONTH, '%Y-%m-01')
...
CROSS JOIN (
    ...
    FROM
        chiphivantai
        LEFT JOIN donhang on chiphivantai.id_donhang = donhang.id_donhang
...
$sql1 = "SELECT  donhang.id_khachhang,sums1.soluongnhienlieu_sum,sums1.tiennhienlieu_sum,
(COALESCE(sums2.tiencuocvo_sum, 0)) as tiencuocvo_sum ,
(COALESCE(sums2.tienhaiquan_sum, 0)) as tienhaiquan_sum ,
(COALESCE(sums2.tiennangha_sum, 0)) as tiennangha_sum ,
(COALESCE(sums2.tienkhac_sum, 0)) as tienkhac_sum ,
sums3.phicauduong_sum,sums3.tienanca_sum,sums3.luongchuyen_sum,sums3.luongchunhat_sum,sums3.tienthuexengoai_sum,sums.thuthutuc_sum,sums.thukhac_sum,sums3.giacuocvantai_sum,
sums.tongdoanhthu_sum,
sums.tongchi_sum AS tongchi_sum,
(sums.loinhuan_sum ) as  loinhuan_sum,
sums.1_3_loinhuan_sum,
...
LEFT JOIN (
   ...
   FROM
      phieudonhienlieu 
  LEFT JOIN donhang ON donhang.id_donhang = phieudonhienlieu.id_donhang
LEFT JOIN khachhang ON khachhang.id_khachhang = donhang.id_khachhang
    WHERE
       donhang.trangthai = 'Hoàn thành'
       AND donhang.ngaytao >= DATE_FORMAT(NOW(), '%Y-%m-01')
       AND donhang.ngaytao < DATE_FORMAT(NOW() + INTERVAL 1 MONTH, '%Y-%m-01')
...
LEFT JOIN (
   ...
   FROM
       chitietdonhangtamung
   LEFT JOIN donhang ON donhang.id_donhang = chitietdonhangtamung.id_donhang
LEFT JOIN khachhang ON khachhang.id_khachhang = donhang.id_khachhang
    WHERE
       donhang.trangthai = 'Hoàn thành'
       AND donhang.ngaytao >= DATE_FORMAT(NOW(), '%Y-%m-01')
...
LEFT JOIN (
   ...
   FROM
       chiphivantai
   LEFT JOIN donhang ON donhang.id_donhang = chiphivantai.id_donhang
LEFT JOIN khachhang ON khachhang.id_khachhang = donhang.id_khachhang
    WHERE
       donhang.trangthai = 'Hoàn thành'
       AND donhang.ngaytao >= DATE_FORMAT(NOW(), '%Y-%m-01')
...
FROM suachua
LEFT JOIN xe ON suachua.id_xe = xe.id_xe
CROSS JOIN (
...
<?php
if (!empty($resultSC) && isset($tongtiensuachua_sum)) {
  $tongtiensuachua_sum = $resultSC[0]['tongtiensuachua_sum'];
//   echo $tongtiensuachua_sum;

} else {
  $tongtiensuachua_sum = 0;
//   echo $tongtiensuachua_sum;
}
            ...
            <div class="d-flex">
                ...
                <form class="form-inline ml-auto mr-4 border p-3 rounded filterBCLN" method="GET">
                    ...
                    <div class="form-group ml-3">
                        ...
                        <a href="baocaoloinhuan.php" class="btn btn-danger">Làm mới</a>
                    </div>
                </form>
            </div>
                        ...
                        <tbody style=" white-space: nowrap;">
                            ...
                            <?php if ($hasData): ?>
                                <tr class="bg-row-sum">
                                    ...
                                    <td>
                                        <?php echo number_format($tongtiensuachua_sum, 0, ',', ','); ?>
                                    </td>
                                    <!-- tổng chi chưa có chi sửa chữa-->
                                    <td><?php echo number_format($items['tongchi_sum'], 0, ',', ','); ?></td>
                                    <!-- tổng chi đã có chi sửa chữa-->
                                    <td><?php echo number_format($items['tongchi_sum'] + $tongtiensuachua_sum, 0, ',', ','); ?>
                                    </td>
                                    <!-- tổng lơi nhuận đã trừ chi sửa chữa -->
                                    <td><?php echo number_format($items['loinhuan_sum'] - $tongtiensuachua_sum, 0, ',', ','); ?>
                                    </td>
                                    <!-- 1.3% của lợi nhuận -->
                                    <td><?php echo number_format(1.3 / 100 * ($items['loinhuan_sum'] - $tongtiensuachua_sum), 0, ',', ','); ?>
                                    </td>
                                    <!-- lợi nhuận đã trừ 1.3% -->
                                    <td><?php echo number_format(($items['loinhuan_sum'] - $tongtiensuachua_sum) - (1.3 / 100 * ($items['loinhuan_sum'] - $tongtiensuachua_sum)), 0, ',', ','); ?>
                                    </td>
                                    <td></td>
                                </tr>
                            <?php endif; ?>
