...
$sql = "SELECT nhansu.id_nhansu, nhansu.ten, nguoidung.tendangnhap AS nguoitao, nguoidung.id_nguoidung, DATE(nhansu.ngaytao) as ngaytao, nguoidung2.tendangnhap AS nguoisua, nguoidung2.id_nguoidung, DATE(nhansu.ngaysua) as ngaysua
        FROM nhansu
        INNER JOIN nguoidung ON nhansu.id_nguoitao = nguoidung.id_nguoidung
        ...
        <div class="container-fluid">
            ...
            <div class="d-flex">
                ...
                <button type="button" class="btn btn-primary " data-toggle="modal" data-target="#exampleModal"
                    data-whatever="@mdo">Thêm tỉnh thành</button>
