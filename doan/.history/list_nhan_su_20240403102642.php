...
$sql = "SELECT nhansu.id_nhansu, nhansu.ten, 
                nguoidung.tendangnhap AS nguoitao, 
                nguoidung.id_nguoidung, DATE(nhansu.ngaytao) as ngaytao, nguoidung2.tendangnhap AS nguoisua, nguoidung2.id_nguoidung, DATE(nhansu.ngaysua) as ngaysua
        FROM nhansu
