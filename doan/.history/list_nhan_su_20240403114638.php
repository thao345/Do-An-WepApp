                            ...
                            <form class="needs-validation" novalidate action="them_tinhthanh.php" method="POST">
                                <div class="form-row">
                                    ...
                                    <div class="col-md-5 mb-3">
                                        <!-- Sử dụng col-md-9 để ô nhập "tên tỉnh thành" chiếm phần còn lại của hàng -->
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" class="form-control" name="tenphongban" id="validationCustom02"
                                            placeholder="Tên phòng ban" value="" required>
                                        <div class="invalid-feedback">
                                            Nhập tên phòng ban.
                                        </div>
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" class="form-control" name="tenphongban" id="validationCustom02"
                                            placeholder="Tên phòng ba" value="" required>
                                        <div class="invalid-feedback">
                                            Nhập tên phòng ban.
                                        </div>
                                    </div>
