...
if (isset($_POST['thembtn'])) {
    ...
    $_POST['stk']) {
        ...
        $sql = "INSERT INTO nhansu (id_nhansu, ten, tenphongban, chucvu, nguyenquan, diachithuongtru, ngaysinh, cmnd, sđt, stk, tennganhang) 
                            VALUES ('$idtt', '$ten', '2', current_timestamp())";
