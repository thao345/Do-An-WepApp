...
if (isset($_POST['thembtn'])) {
    if ($_POST['id_nhansu'] && $_POST['ten']&& $_POST['tenphongban']&& $_POST['chucvu']&& $_POST['nguyenquan']&& $_POST['diachithuongtru']&& $_POST['ngaysinh']&& $_POST['cmnd']&& $_POST['sđt']&& $_POST['nganhang']&& $_POST['stk']) {
