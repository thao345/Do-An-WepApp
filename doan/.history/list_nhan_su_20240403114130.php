...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div class="col-md-3 mb-3">
        ...
        <input type="text" class="form-control" name="id_tinhthanh" id="validationCustom01" placeholder="Mã nhân sự" value="" required>
        <div class="invalid-feedback">
            Nhập mã nhân sự.
        </div>
    </div>
    <div class="col-md-9 mb-3"> <!-- Sử dụng col-md-9 để ô nhập "tên tỉnh thành" chiếm phần còn lại của hàng -->
        <label for="validationCustom02">Tên tỉnh thành</label>
        <input type="text" class="form-control" name="ten" id="validationCustom02" placeholder="Tên tỉnh thành" value="" required>
        <div class="invalid-feedback">
            Nhập tên tỉnh thành.
        </div>
    </div>
