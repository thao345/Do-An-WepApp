...
if (isset($_POST['luubtn'])) {
    ...
    $sql = "UPDATE nhansu
        SET ten = '$ten', tenphongban = '$tenphongban', chucvu = '$chucvu', nguyenquan = '$nguyenquan', diachithuongtru = '$diachithuongtru', ngaysinh = '$ngaysinh', cmnd = '$', sđt = '', stk = '', tennganhang = '', id_nguoisua = '3', ngaysua = current_timestamp()
