...
if (isset($_POST['suabtn'])) {
    $idtt = $_POST['edit_id'];
    $sql = "SELECT * FROM `nhansu` WHERE id_tinhthanh ='$idtt'";
...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <!-- Page Heading -->
            <h1 class="h3 mb-4 text-gray-800  text-center header-crud">Sửa tỉnh thành</h1>
                    ...
                    <div class="form-row">
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="text" readonly class="form-control" name="id_edit" id="validationCustom01"
                                placeholder="Mã tỉnh thành" value="<?php echo $items['id_tinhthanh']; ?>" required>
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="text" class="form-control" name="ten_edit" id="validationCustom02"
                                placeholder="Tên tỉnh thành" value="<?php echo $items['ten']; ?>" required>
                            <div class="invalid-feedback">
                                Nhập tên tỉnh thành.
                            </div>
                        </div>
