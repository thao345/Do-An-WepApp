                                ...
                                <div class="col-md-4 mb-3">
                                        ...
                                        <div class="col-md-8 mb-3">
                                            ...
                                            <input type="text" class="form-control" name="ten" id="validationCustom02"
                                                placeholder="Tên nhân sự" value="<?php echo $items['id_tinhthanh']; ?>" required>
                                            <div class="invalid-feedback">
                                                Nhập tên nhân sự.
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control" name="tenphongban"
                                                id="validationCustom02" placeholder="Tên phòng ban" value="<?php echo $items['id_tinhthanh']; ?>" required>
                                            <div class="invalid-feedback">
                                                Nhập tên phòng ban.
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control" name="chucvu"
                                                id="validationCustom02" placeholder="Chức vụ" value="<?php echo $items['id_tinhthanh']; ?>" required>
                                            <div class="invalid-feedback">
                                                Chức vụ.
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <input type="text" class="form-control" name="nguyenquan"
                                                id="validationCustom02" placeholder="Nguyên quán" value="<?php echo $items['id_tinhthanh']; ?>" required>
                                            <div class="invalid-feedback">
                                                Nguyên quán.
                                            </div>
                                        </div>
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <input type="text" class="form-control" name="diachithuongtru"
                                                id="validationCustom02" placeholder="Địa chỉ thường trú" value="<?php echo $items['id_tinhthanh']; ?>" required>
                                            <div class="invalid-feedback">
                                                Địa chỉ thường trú.
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input type="text" class="form-control" name="ngaysinh"
                                                id="validationCustom02" placeholder="Ngày sinh" value="<?php echo $items['id_tinhthanh']; ?>" required>
                                            <div class="invalid-feedback">
                                                Ngày sinh.
                                            </div>
                                        </div>
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input type="text" class="form-control" name="cmnd"
                                                id="validationCustom02" placeholder="Căn cước công dân" value="<?php echo $items['id_tinhthanh']; ?>" required>
                                            <div class="invalid-feedback">
                                                Căn cước công dân.
                                            </div>
                                        </div>
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input type="text" class="form-control" name="sđt"
                                                id="validationCustom02" placeholder="Số điện thoại" value="<?php echo $items['id_tinhthanh']; ?>" required>
                                            <div class="invalid-feedback">
                                            Số điện thoại.
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control" name="nganhang"
                                                id="validationCustom02" placeholder="Tên ngân hàng" value="<?php echo $items['id_tinhthanh']; ?>" required>
                                            <div class="invalid-feedback">
                                                Tên ngân hàng.
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control" name="stk"
                                                id="validationCustom02" placeholder="Số tài khoản" value="<?php echo $items['id_tinhthanh']; ?>" required>
                                            <div class="invalid-feedback">
                                                Số tài khoản.
                                            </div>
                                        </div>
