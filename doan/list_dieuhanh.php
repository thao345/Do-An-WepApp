...
WHERE 1   AND dieuhanh.ngaytao >= DATE_FORMAT(NOW(), '%Y-%m-01')
        AND dieuhanh.ngaytao < DATE_FORMAT(NOW() + INTERVAL 1 MONTH, '%Y-%m-01')
            ...
            <div class="d-flex">
                ...
                <form class="form-inline ml-auto mr-4 border p-3 rounded filterDonHang " method="GET">
                    <div class="form-group">
                        ...
                        <div class="input-group ml-3">
                            <div class="input-group-prepend">
                                <span class="input-group-text" id="basic-addon3">Thầu phụ</span>
                            </div>
                    ...
                    <div class="form-group ml-3">
                        ...
                        <a href="list_dieuhanh.php" class="btn btn-danger">Làm mới</a>
                    </div>
                </form>
            </div>
                                ...
                                <tr data-id="<?php echo $items['id_dieuhanh']; ?>"
                                    ...
                                    <td>
                                        ...
                                        <button class="btn  btn-delete  btn-block" data-toggle="modal"
                                            data-target="#deleteModal<?php echo $items['id_dieuhanh']; ?>" <?php echo $disableXoa; ?>><i class="fas fa-trash"></i></button>
                                    </td>
                                </tr>
