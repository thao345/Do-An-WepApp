...
if (isset($_GET['from_date']) && isset($_GET['to_date'])) {
    ...
    $sql = "SELECT nhomhanghoa.id_nhomhanghoa, nhomhanghoa.ten, nguoidung.tendangnhap AS nguoitao, nguoidung.id_nguoidung, DATE(nhomhanghoa.ngaytao) as ngaytao, nguoidung2.tendangnhap AS nguoisua, nguoidung2.id_nguoidung, DATE(nhomhanghoa.ngaysua) as ngaysua
            ...
            INNER JOIN nguoidung ON nhomhanghoa.id_nguoitao = nguoidung.id_nguoidung
            LEFT JOIN nguoidung AS nguoidung2 ON nhomhanghoa.id_nguoisua = nguoidung2.id_nguoidung
            WHERE nhomhanghoa.ngaytao BETWEEN '$from_date 00:00:00' AND '$to_date 23:59:59'
            ORDER BY nhomhanghoa.ngaytao DESC
            LIMIT $offset,$total_records_per_page";
            ...
            <div class="d-flex"> 
                ...
                <form class="form-inline ml-auto mr-4 border p-3 rounded filterTinhThanh" method="GET">
                    ...
                    <button type="submit" name="filter" class="btn btn-primary mr-2">Lọc</button>
                        <a href="list_nhomhang.php" class="btn btn-danger">Làm mới</a>
                    </div>
                </form>
            </div>
                ...
                <table class=" table  table-bordered table-hover " id="myTable" width="100%" cellspacing="0">
                        <thead style=" white-space: nowrap;" class="thead-dark">
                            <tr>
                                 ...
                                 <th class="text-center">Mã nhóm hàng </th>
                                 <th class="text-center">Tên nhóm hàng</th>
                            ...
                            foreach ($result as $items):
                                ...
                                <tr data-id="<?php echo $items['id_nhomhanghoa']; ?>">
                                    ...
                                    <td>
                                        ...
                                        <input type="hidden" name="edit_id"value="<?php echo $items['id_nhomhanghoa']; ?>">
                                    ...
                                    <td>
                                        ...
                                        <div class="modal" id="deleteModal-<?php echo $items['id_nhomhanghoa']; ?>" tabindex="-1" role="dialog">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <p>Bạn có chắc chắn muốn xóa nhóm hàng
                                                            <strong>
                                        ...
                                        <button class="btn  btn-delete  btn-block" data-toggle="modal"
                                            data-target="#deleteModal-<?php echo $items['id_nhomhanghoa']; ?>">
