...
if (isset($_POST['thembtn'])) {
    if (
        ...
        VALUES ('$id_lichtrinh', '$ten', '$loaihang' ,'$id_nhomhanghoa', current_timestamp(),'$id_nguoidung')";
...
if (isset($_POST['xoabtn'])) {
    ...
    $sql1 = "UPDATE `lichtrinh` SET `id_nguoisua`='$id_nguoidung' WHERE id_lichtrinh = '$id'";
