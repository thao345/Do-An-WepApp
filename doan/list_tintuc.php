                            ...
                            <form class="needs-validation" novalidate action="them_tintuc.php" method="POST"
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <select name="special" id="validationCustom02" class="form-control">
                        ...
                        <tbody style=" white-space: nowrap;">
                            ...
                            foreach ($result as $items):
                                ...
                                <tr  data-id="<?php echo $items['id_tintuc']; ?>">
                                    ...
                                    <td style="text-align: justify; min-width: 300px; white-space: normal;">
                                        <?php echo $items['tieude']; ?>
                                    </td>
                                  
                                    <td>
                                        <a href="../Pacific/images/<?php echo $items['img']; ?>" target="_blank">
                                            <img style="width: 100px;"
                                                src="../Pacific/images/<?php echo $items['img']; ?>">
                                        </a>
                                    </td>


                                    <td>
                                        <?php if ($items['ngaytao'] != null)
                                    ...
                                    <td>
                                        ...
                                        <div class="modal" id="deleteModal-<?php echo $items['id_tintuc']; ?>" tabindex="-1"
                                            role="dialog">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <p>Bạn có chắc chắn muốn xóa tin tức có mã <strong>
                                                                <?php echo $items['id_tintuc']; ?></strong>?</p>
                                                    </div>
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-secondary"
                                                            data-dismiss="modal">Hủy</button>
                                                        <form method="POST" action="them_tintuc.php">
                                                            <input type="hidden" name="delete_id"
                                                                value="<?php echo $items['id_tintuc']; ?>">
                                        ...
                                        <button class="btn  btn-delete  btn-block" data-toggle="modal"
                                            data-target="#deleteModal-<?php echo $items['id_tintuc']; ?>">
