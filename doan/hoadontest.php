...
<body>
    <header>
        ...
        <div class="col-sm-6" contenteditable>
            <div class="invoice-contact-us">
                <ul class="link">
                    ...
                    <li>
                        <i class="fa fa-envelope"></i> <a href="mailto:sales@hotelempire.com">pacific@gmail.com</a>
                    </li>
                    <li>
        ...
        <span><img alt="ảnh nè" src="img/logo-rm.png" style="width: 125px;"><input type="file" accept="image/*"></span>
    </header>
    <article>
        <h1>Recipient</h1>
