            ...
            <div class="d-flex">
                ...
                <form class="form-inline ml-auto mr-4 border p-3 rounded filterBCSC " method="GET">
                    ...
                    <div class="form-group ml-3">
                        ...
                        <a href="list_suachua.php" class="btn btn-danger">Làm mới</a>
                    </div>
                </form>
            </div>
            <script>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group mb-2">
                                            ...
                                            <input type="text" class="form-control" id="sokmdongho_display"
                                                placeholder="Nhập số km đồng hồ..." value="" required>
                                            <input type="hidden" name="sokmdongho" id="sokmdongho" value="" required>
                                            <div class="input-group-prepend">
                                                <div
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <div class="input-group mb-2">
                                            ...
                                            <input type="hidden" name="dongiavattu" id="dongiavattu" value="" required>
                                            <div class="input-group-prepend">
                                                <div
                                                    class="input-group-text rounded-right text-gray-100 bg-gradient-primary">
                                                    VNĐ</div>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="number" class="form-control" name="soluong" id="soluong"
                                            placeholder="Nhập số lượng..." value="1" min="1">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <div class="input-group mb-2">
                                            <input type="text" class="form-control" id="tiennhancong_display"
                                                placeholder="Nhập tiền nhân công..." value="0">
                                            <input type="hidden" name="tiennhancong" id="tiennhancong" value="0">
                                            <div class="input-group-prepend">
                                                <div
                                                    class="input-group-text rounded-right text-gray-100 bg-gradient-primary">
                                                    VNĐ</div>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <div class="input-group mb-2">
                                            ...
                                            <input type="hidden" name="tongtien" id="tongtien" value="" required readonly>
                                            <div class="input-group-prepend">
                                                <div
                                                    class="input-group-text rounded-right text-gray-100 bg-gradient-primary">
                                                    VNĐ</div>
                        ...
                        <tbody style=" white-space: nowrap;">
                            ...
                            foreach ($result as $items):
                                ...
                                <tr data-id="<?php echo $items['id_suachua']; ?>"
                                    ...
                                    <td>
                                        <?php echo number_format($items['sokmdongho'], 0, ',', '.'); ?>
