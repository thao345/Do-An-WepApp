...
if (isset($_POST['thembtn'])) {
    if (
        ...
        '$tienthuexengoai_cpvt', '$tongchiphi_cpvt','$ghichu_cpvt',current_timestamp(),'$id_nguoidung')";
...
if (isset($_POST['luubtn'])) {
    ...
    `ghichu`='$ghichu_cpvt',`ngaysua`=current_timestamp(),`id_nguoisua`='$id_nguoidung'
...
if (isset($_POST['xoabtn'])) {
    ...
    $sql1 = "UPDATE `chiphivantai` SET `id_nguoisua`='$id_nguoidung' WHERE id_cpvt = '$id_cpvt'";
