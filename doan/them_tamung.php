...
if (isset($_POST['luubtn'])) {
    ...
    `giothanhtoan`='$giothanhtoan_tamung',`ghichu`='$ghichu_tamung',`anh1`='$image',`ngaysua`=current_timestamp(),`id_nguoisua`='$id_nguoidung'
...
if (isset($_POST['xoabtn'])) {
    ...
    $sql1 = "UPDATE `chitietdonhangtamung` SET `id_nguoisua`='$id_nguoidung' WHERE id_ctdhtu = '$id_ctdhtu'";
