...
$sqlCount = "SELECT COUNT(DISTINCT taixe.id_taixe) as total_rows
             FROM taixe
...
$sql = "SELECT taixe.id_taixe, taixe.ten, COUNT(donhang.id_donhang) AS so_don_hang_hoan_thanh
        FROM taixe
        INNER JOIN dieuhanh ON taixe.id_taixe = dieuhanh.id_taixe
        INNER JOIN donhang ON donhang.id_donhang = dieuhanh.id_donhang
        WHERE donhang.trangthai = 'Hoàn thành'
...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <!-- Page Heading -->
            <h1 class="h3 mb-4 text-gray-800  text-center header-crud">Danh sách tài xế thực hiện đơn hàng</h1>
            <!-- Topbar Search -->
            <div class="d-flex">
                ...
                <table class=" table  table-bordered table-hover " id="myTable" width="100%" cellspacing="0">
                        <thead style=" white-space: nowrap;" class="thead-dark">
                            <tr>
                                 ...
                                 <th class="text-center">Số đơn hàng hoàn thành</th>
                        ...
                        <tbody style=" white-space: nowrap;">
                            ...
                            foreach ($result as $items):
                                ...
                                <tr  data-id="<?php echo $items['id_taixe']; ?>">
                                    ...
                                    <td class="text-center">
                                    <?php echo $items['so_don_hang_hoan_thanh']; ?>
                                    </td>
