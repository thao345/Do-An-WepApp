...
if (isset($_POST['suabtn'])) {
    $id = $_POST['edit_id'];
    $sql = "SELECT * FROM `nhomxe` WHERE id_nhomxe ='$id'";
...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <!-- Page Heading -->
            <h1 class="h3 mb-4 text-gray-800  text-center header-crud">Sửa nhóm xe</h1>
            ...
            <form class="needs-validation" novalidate action="them_nhomxe.php" method="POST">
                    ...
                    <div class="form-row">
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="text" readonly class="form-control" name="id_edit" id="validationCustom01"
                                placeholder="Mã nhóm xe" value="<?php echo $items['id_nhomxe']; ?>" required>
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="text" class="form-control" name="ten_edit" id="validationCustom02"
                                placeholder="Tên nhóm xe" value="<?php echo $items['ten']; ?>" required>
                            <div class="invalid-feedback">
                                Nhập tên nhóm xe.
                            </div>
                        </div>
                ...
                <div class="modal-footer">
                    <a href="list_nhomxe.php" class="btn btn-secondary mr-3">Trở lại </a>
