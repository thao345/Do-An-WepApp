...
if (isset($_POST['thembtn'])) {
    if (
        ...
        VALUES ('$bienso', 'OK','$id_nhomxe','$tennhomxe','$id_nhienlieu','$id_thauphu','$id_nhomhang', current_timestamp(),'$id_nguoidung')";
...
if (isset($_POST['luubtn'])) {
    ...
    $sql = "UPDATE xe
        ...
        id_nhomhang = '$id_nhomhang', id_nguoisua = '$id_nguoidung', ngaysua = current_timestamp()
        WHERE id_xe = '$id'";
...
if (isset($_POST['xoabtn'])) {
    ...
    $sql1 = "UPDATE `xe` SET `id_nguoisua`='$id_nguoidung' WHERE id_xe = '$id'";
