                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <input value="<?php echo $tendangnhap; ?>" type="text" class="form-control"
                                        id="inputUsername" name="inputUsername" placeholder="Tên đăng nhập" readonly>
                                </div>
                                <div class="mb-3">
                ...
                <div class="card-body">
                    ...
                    <form action="account/save_change_setting.php" method="POST">
                        <div class="mb-3">
                            ...
                            <input type="password" class="form-control" name="currentPas" id="inputPasswordCurrent"
                                required>
