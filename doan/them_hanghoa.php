...
if (isset($_POST['thembtn'])) {
    if (
        ...
        VALUES ('$id_hanghoa', '$ten','$id_nhomhanghoa','$kichthuoc','$donvitinh','$ghichu', current_timestamp(),'$id_nguoidung')";
...
if (isset($_POST['xoabtn'])) {
    ...
    $sql1 = "UPDATE `hanghoa` SET `id_nguoisua`='$id_nguoidung' WHERE id_hanghoa = '$id'";
