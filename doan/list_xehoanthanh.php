...
$sqlCount = "SELECT COUNT(DISTINCT xe.id_xe) as total_rows
             FROM xe
...
$sql = "SELECT xe.id_xe, xe.bienso, COUNT(donhang.id_donhang) AS so_don_hang_hoan_thanh
        FROM xe
        INNER JOIN dieuhanh ON xe.id_xe = dieuhanh.id_xe
        INNER JOIN donhang ON donhang.id_donhang = dieuhanh.id_donhang
        WHERE donhang.trangthai = 'Hoàn thành'
...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <!-- Page Heading -->
            <h1 class="h3 mb-4 text-gray-800  text-center header-crud">Danh sách xe chạy số chuyến</h1>
            <!-- Topbar Search -->
            <div class="d-flex">
