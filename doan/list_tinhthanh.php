...
$sqlCount = "SELECT COUNT(*) as total_rows FROM tinhthanh";
...
$sql = "SELECT tinhthanh.id_tinhthanh, tinhthanh.ten, nguoidung.tendangnhap AS nguoitao, nguoidung.id_nguoidung, DATE(tinhthanh.ngaytao) as ngaytao, nguoidung2.tendangnhap AS nguoisua, nguoidung2.id_nguoidung, DATE(tinhthanh.ngaysua) as ngaysua
        FROM tinhthanh
        INNER JOIN nguoidung ON tinhthanh.id_nguoitao = nguoidung.id_nguoidung
        LEFT JOIN nguoidung AS nguoidung2 ON tinhthanh.id_nguoisua = nguoidung2.id_nguoidung
        WHERE 1
...
if (isset($_GET['filter'])) {
    if (isset($_GET['from_date']) && isset($_GET['to_date'])) {
        ...
        $sql = "SELECT tinhthanh.id_tinhthanh, tinhthanh.ten, nguoidung.tendangnhap AS nguoitao, nguoidung.id_nguoidung, DATE(tinhthanh.ngaytao) as ngaytao, nguoidung2.tendangnhap AS nguoisua, nguoidung2.id_nguoidung, DATE(tinhthanh.ngaysua) as ngaysua
                ...
                INNER JOIN nguoidung ON tinhthanh.id_nguoitao = nguoidung.id_nguoidung
                LEFT JOIN nguoidung AS nguoidung2 ON tinhthanh.id_nguoisua = nguoidung2.id_nguoidung
                WHERE tinhthanh.ngaytao BETWEEN '$from_date  00:00:00' AND '$to_date 23:59:59'
                ORDER BY tinhthanh.ngaytao DESC
                LIMIT $offset,$total_records_per_page";
...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <!-- Page Heading -->
            <h1 class="h3 mb-4 text-gray-800  text-center header-crud">Danh sách tỉnh thành</h1>
            <!-- Topbar Search -->
            <div class="d-flex">
                <div class="d-flex mt-3 mb-3 float-right">
                    <button type="button" class="btn btn-primary align-self-center" data-toggle="modal"
                        data-target="#exampleModal" data-whatever="@mdo">Thêm tỉnh thành</button>
                ...
                <form class="form-inline ml-auto mr-4 border p-3 rounded filterTinhThanh" method="GET">
                    ...
                    <div class="form-group ml-3">
                        ...
                        <a href="list_tinhthanh.php" class="btn btn-danger">Làm mới</a>
                            ...
                            <form class="needs-validation" novalidate action="them_tinhthanh.php" method="POST">
                                <div class="form-row">
                                    <div class="col-md-12 mb-3">
                                        <label for="validationCustom01">Mã tỉnh thành:</label>
                                        <input type="text" class="form-control" name="id_tinhthanh"
                                            id="validationCustom01" placeholder="Mã tỉnh thành" value="" required>
                                        <div class="invalid-feedback">
                                            Nhập mã tỉnh thành.
                                        </div>
                                    </div>
                                    <div class="col-md-12 mb-3">
                                        <label for="validationCustom02">Tên tỉnh thành:</label>
                                        <input type="text" class="form-control" name="ten" id="validationCustom02"
                                            placeholder="Tên tỉnh thành" value="" required>
                                        <div class="invalid-feedback">
                                            Nhập tên tỉnh thành.
                                        </div>
                                    </div>
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <div class="dropdown">
                        <button class="btn btn-secondary dropdown-toggle mb-3" type="button" id="columnDropdown"
                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            Chọn cột ẩn
                        </button>
                        <div class="dropdown-menu" aria-labelledby="columnDropdown">
                            <label class="dropdown-item">
                                <input type="checkbox" name="matinh" class="column-checkbox checkbox-to"> Mã tỉnh
                            </label>
                            <label class="dropdown-item">
                                <input type="checkbox" name="tentinh" class="column-checkbox checkbox-to"> Tên tỉnh
                            </label>
                        </div>
                    </div>
                    ...
                    <table class=" table  table-bordered table-hover " id="myTable" width="100%" cellspacing="0">
                        <thead style=" white-space: nowrap;" class="thead-dark">
                            <tr>
                                <th draggable="true" ondragstart="drag(event)" class="text-center">STT</th>
                                <th draggable="true" ondragstart="drag(event)" class="text-center matinh">Mã tỉnh </th>
                                <th draggable="true" ondragstart="drag(event)" class="text-center">Tên tỉnh</th>
                                <th draggable="true" ondragstart="drag(event)" class="text-center">Ngày tạo</th>
                                <th draggable="true" ondragstart="drag(event)" class="text-center">Người tạo</th>
                                <th draggable="true" ondragstart="drag(event)" class="text-center">Ngày sửa</th>
                                <th draggable="true" ondragstart="drag(event)" class="text-center">Người sửa</th>

                                <th draggable="true" ondragstart="drag(event)" colspan="2" class="text-center">Actions
                                </th>
                            </tr>
                        </thead>
                        ...
                        <tbody style=" white-space: nowrap;">
                            ...
                            foreach ($result as $items):
                                ...
                                <tr data-id="<?php echo $items['id_tinhthanh']; ?>">
                                    <td>
                                        <?php echo $count++; ?>
                                    </td>
                                    <td class="matinh">
                                        <?php echo $items['id_tinhthanh']; ?>
                                    </td>
                                    <td>
                                        <?php echo $items['ten']; ?>
                                    </td>
                                    ...
                                    <td>
                                        <!-- Thêm modal dialog -->
                                        <div class="modal" id="deleteModal-<?php echo $items['id_tinhthanh']; ?>"
                                        ...
                                        <button class="btn  btn-delete  btn-block" data-toggle="modal"
                                            data-target="#deleteModal-<?php echo $items['id_tinhthanh']; ?>">
    ...
    <script>
        ...
        $('tr[data-id]').on('dblclick', function () {
            ...
            window.location.href = 'sua_tinhthanh.php?edit_id=' + id;
        });
