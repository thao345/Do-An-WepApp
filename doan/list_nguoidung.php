...
$sql = "SELECT nguoidung.id_nguoidung, nguoidung.tendangnhap, nguoidung.matkhau,nguoidung.trangthai, nguoidung.isadmin,  nguoidung2.tendangnhap AS nguoitao, DATE(nguoidung.ngaytao) as ngaytao, nguoidung3.tendangnhap AS nguoisua, DATE(nguoidung.ngaysua) as ngaysua
        FROM nguoidung 
        LEFT JOIN nguoidung AS nguoidung2 ON nguoidung.id_nguoitao = nguoidung2.id_nguoidung
        LEFT JOIN nguoidung AS nguoidung3 ON nguoidung.id_nguoisua = nguoidung3.id_nguoidung
        WHERE 1
