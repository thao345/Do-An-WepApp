...
$sqlCount = "SELECT COUNT(*) as total_rows FROM donhang WHERE 1 
AND donhang.ngaytao >= DATE_FORMAT(NOW(), '%Y-%m-01') AND donhang.ngaytao < DATE_FORMAT(NOW() + INTERVAL 1 MONTH, '%Y-%m-01')";
...
if (isset($_GET['filter'])) {
    ...
    if (!empty($trangthai)) {
        ...
        $sql .= " AND donhang.trangthai = '$trangthai'  AND donhang.ngaytao >= DATE_FORMAT(NOW(), '%Y-%m-01')
    AND donhang.ngaytao < DATE_FORMAT(NOW() + INTERVAL 1 MONTH, '%Y-%m-01') ";
        $sqlSoLuong .= " AND donhang.trangthai = '$trangthai'  AND donhang.ngaytao >= DATE_FORMAT(NOW(), '%Y-%m-01')
    AND donhang.ngaytao < DATE_FORMAT(NOW() + INTERVAL 1 MONTH, '%Y-%m-01')";
    }
...
<!-- checkbox to hidden col table -->
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.7.1/jquery.min.js"></script>
<script>
    // Đặt mã JavaScript trong sự kiện "DOMContentLoaded"
        ...
        <div class="container-fluid">
            ...
            <div class="d-flex">
                ...
                <form class="form-inline ml-auto mr-4 border p-3 rounded filterDonHang " method="GET">
                    ...
                    <div class="form-group ml-3">
                        ...
                        <a href="list_donhang.php" class="btn btn-danger">Làm mới</a>
                    </div>
                </form>
            </div>
            <script>
            ...
            <div class="d-flex justify-content-between">
                <div class="dropdown mt-4 mb-3">
                    ...
                    <div class="dropdown-menu dropdown-menu-scrollable" aria-labelledby="columnDropdown"
                        onclick="event.stopPropagation();">
                        <label class="dropdown-item">
                            <input type="checkbox" name="stt" class="column-checkbox checkbox-to"> STT
                        </label>
                        <label class="dropdown-item">
                            <input type="checkbox" name="madonhang" class="column-checkbox checkbox-to"> Mã đơn hàng
                        </label>
                        <label class="dropdown-item">
                            <input type="checkbox" name="sales" class="column-checkbox checkbox-to"> Sales
                        </label>
                        <label class="dropdown-item">
                            <input type="checkbox" name="makhachhang" class="column-checkbox checkbox-to"> Mã khách hàng
                        </label>
                        <label class="dropdown-item">
                            <input type="checkbox" name="masothue" class="column-checkbox checkbox-to"> Mã số thuế
                        </label>
                        <label class="dropdown-item">
                            <input type="checkbox" name="sobooking" class="column-checkbox checkbox-to"> Số booking
                        </label>
                        <label class="dropdown-item">
                            <input type="checkbox" name="loaihang" class="column-checkbox checkbox-to"> Loại hàng
                        </label>
                        <label class="dropdown-item">
                            <input type="checkbox" name="linesfwd" class="column-checkbox checkbox-to"> Lines/FWD
                        </label>
                        <label class="dropdown-item">
                            <input type="checkbox" name="manhomhang" class="column-checkbox checkbox-to"> Mã nhóm hàng
                        </label>
                        <label class="dropdown-item">
                            <input type="checkbox" name="loaixe" class="column-checkbox checkbox-to"> Loại xe(Tên hàng
                            hóa)
                        </label>
                        <label class="dropdown-item">
                            <input type="checkbox" name="soluong" class="column-checkbox checkbox-to"> Số lượng
                        </label>
                        <label class="dropdown-item">
                            <input type="checkbox" name="sokg" class="column-checkbox checkbox-to"> Số kg
                        </label>
                        <label class="dropdown-item">
                            <input type="checkbox" name="trangthai" class="column-checkbox checkbox-to"> Trạng thái
                        </label>
                        <label class="dropdown-item">
                            <input type="checkbox" name="ngaydongcont" class="column-checkbox checkbox-to"> Ngày đóng
                            cont
                        </label>
                        <label class="dropdown-item">
                            <input type="checkbox" name="giodongcont" class="column-checkbox checkbox-to"> Giờ đóng cont
                        </label>
                        <label class="dropdown-item">
                            <input type="checkbox" name="tentuyenvantai" class="column-checkbox checkbox-to"> Tên tuyến
                            vận tải
                        </label>
                        <label class="dropdown-item">
                            <input type="checkbox" name="culy" class="column-checkbox checkbox-to"> Cự ly(Km)
                        </label>
                        <label class="dropdown-item">
                            <input type="checkbox" name="ngaycatmang" class="column-checkbox checkbox-to"> Ngày cắt máng
                        </label>
                        <label class="dropdown-item">
                            <input type="checkbox" name="giocatmang" class="column-checkbox checkbox-to"> Giờ cắt máng
                        </label>
                        <label class="dropdown-item">
                            <input type="checkbox" name="nguoigiaonhan" class="column-checkbox checkbox-to"> Người giao
                            nhận
                        </label>
                        <label class="dropdown-item">
                            <input type="checkbox" name="sodienthoai" class="column-checkbox checkbox-to"> Số điện thoại
                        </label>
                        <label class="dropdown-item">
                            <input type="checkbox" name="thuthutuc" class="column-checkbox checkbox-to"> Thu thủ
                            tục(VNĐ)
                        </label>
                        <label class="dropdown-item">
                            <input type="checkbox" name="thukhac" class="column-checkbox checkbox-to"> Thu khác(VNĐ)
                        </label>
                        <label class="dropdown-item">
                            <input type="checkbox" name="hanthanhtoan" class="column-checkbox checkbox-to"> Hạn thanh
                            toán
                        </label>
                        <label class="dropdown-item">
                            <input type="checkbox" name="ghichu" class="column-checkbox checkbox-to"> Ghi chú
                        </label>
                        <label class="dropdown-item">
                            <input type="checkbox" name="anh1" class="column-checkbox checkbox-to"> Ảnh 1
                        </label>
                        <label class="dropdown-item">
                            <input type="checkbox" name="anh2" class="column-checkbox checkbox-to"> Ảnh 2
                        </label>
                        <label class="dropdown-item">
                            <input type="checkbox" name="ngaytao" class="column-checkbox checkbox-to"> Ngày tạo
                        </label>
                        <label class="dropdown-item">
                            <input type="checkbox" name="nguoitao" class="column-checkbox checkbox-to"> Người tạo
                        </label>
                        <label class="dropdown-item">
                            <input type="checkbox" name="ngaysua" class="column-checkbox checkbox-to"> Ngày sửa
                        </label>
                        <label class="dropdown-item">
                            <input type="checkbox" name="nguoisua" class="column-checkbox checkbox-to"> Người sửa
                        </label>
                        <!-- <label class="dropdown-item">
                            <input type="checkbox" name="actions" class="column-checkbox checkbox-to"> Actions
                        </label> -->
                ...
                <table class=" table  table-bordered table-hover " id="myTable" width="100%" cellspacing="0">
                    <thead style=" white-space: nowrap;" class="thead-dark">
                        <tr data-id="<?php echo $items['id_donhang']; ?>"
                            ...
                            <th draggable="true" ondragstart="drag(event)" class="stt">STT</th>
                            <th draggable="true" ondragstart="drag(event)" class="hidden-column">Mã id_ctdhtu</th>
                            <th draggable="true" ondragstart="drag(event)" class="madonhang">Mã đơn hàng </th>
                            <th draggable="true" ondragstart="drag(event)" class="sales">Sales</th>
                            <th draggable="true" ondragstart="drag(event)" class="makhachhang">Mã khách hàng</th>
                            <th draggable="true" ondragstart="drag(event)" class="masothue">Mã số thuế</th>
                            <th draggable="true" ondragstart="drag(event)" class="sobooking">Số booking</th>
                            <th draggable="true" ondragstart="drag(event)" class="loaihang">Loại hàng</th>
                            <th draggable="true" ondragstart="drag(event)" class="linesfwd">Lines/FWD</th>
                            <th draggable="true" ondragstart="drag(event)" class="manhomhang">Mã nhóm hàng</th>
                            <th draggable="true" ondragstart="drag(event)" class="loaixe">Loại xe(Tên hàng hóa)</th>
                            <th draggable="true" ondragstart="drag(event)" class="soluong">Số lượng</th>
                            <th draggable="true" ondragstart="drag(event)" class="sokg">Số kg</th>
                            <th draggable="true" ondragstart="drag(event)" class="trangthai">Trạng thái</th>
                            <th draggable="true" ondragstart="drag(event)" class="ngaydongcont">Ngày đóng cont</th>
                            <th draggable="true" ondragstart="drag(event)" class="giodongcont">Giờ đóng cont</th>
                            <th draggable="true" ondragstart="drag(event)" class="tentuyenvantai">Tên tuyến vận tải</th>
                            <th draggable="true" ondragstart="drag(event)" class="culy">Cự ly(Km)</th>
                            <th draggable="true" ondragstart="drag(event)" class="ngaycatmang">Ngày cắt máng</th>
                            <th draggable="true" ondragstart="drag(event)" class="giocatmang">Giờ cắt máng</th>
                            <th draggable="true" ondragstart="drag(event)" class="nguoigiaonhan">Người giao nhận</th>
                            <th draggable="true" ondragstart="drag(event)" class="sodienthoai">Số điện thoại</th>
                            <th draggable="true" ondragstart="drag(event)" class="hidden-column">Tổng giá cước(VNĐ)</th>
                            <th draggable="true" ondragstart="drag(event)" class="thuthutuc">Thu thủ tục(VNĐ)</th>
                            <th draggable="true" ondragstart="drag(event)" class="thukhac">Thu khác(VNĐ)</th>
                            <th draggable="true" ondragstart="drag(event)" class="hanthanhtoan">Hạn thanh toán</th>
                            <th draggable="true" ondragstart="drag(event)" class="ghichu">Ghi chú</th>
                            <th draggable="true" ondragstart="drag(event)" class="anh1">Ảnh 1</th>
                            <th draggable="true" ondragstart="drag(event)" class="anh2">Ảnh 2</th>

                            <th draggable="true" ondragstart="drag(event)" class="ngaytao">Ngày tạo</th>
                            <th draggable="true" ondragstart="drag(event)" class="nguoitao">Người tạo</th>
                            <th draggable="true" ondragstart="drag(event)" class="ngaysua">Ngày sửa</th>
                            <th draggable="true" ondragstart="drag(event)" class="nguoisua">Người sửa</th>
                    ...
                    <tbody style=" white-space: nowrap;">
                        ...
                        foreach ($result as $items):
                            ...
                            <tr data-id="<?php echo $items['id_donhang']; ?>"
                                ...
                                <td class="text-center trangthai">
                                    <?php
                                ...
                                <td>
                                    <form action="hopdong.php" method="POST" target="_blank">
                                        <!-- <input type="hidden" name="id_cpvt" value="<?php echo $items['id_cpvt']; ?>"> -->
                                        <input type="hidden" name="id_donhang" value="<?php echo $items['id_donhang']; ?>">
