...
if (isset($_POST['suabtn'])) {
    $idtt = $_POST['edit_id'];
    $sql = "SELECT * FROM `thauphu` WHERE id_thauphu ='$idtt'";
...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <!-- Page Heading -->
            <h1 class="h3 mb-4 text-gray-800  text-center header-crud">Sửa thầu phụ</h1>
            ...
            <form class="needs-validation" novalidate action="them_thauphu.php" method="POST">
                    ...
                    <div class="form-row">
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" class="form-control" name="id_thauphu"
                                            id="validationCustom01" placeholder="Mã thầu phụ" value="<?php echo $items['id_thauphu']?>" required readonly>
                                    ...
                                    <div class="col-md-8 mb-3">
                                        ...
                                        <input type="text" class="form-control" name="ten" id="validationCustom02"
                                            placeholder="Tên thầu phụ" value="<?php echo $items['ten']?>" required>
                                        <div class="invalid-feedback">
                                            Nhập tên thầu phụ.
                                        </div>
                                    </div>
                ...
                <div class="modal-footer">
                    <a href="list_thauphu.php" class="btn btn-secondary mr-3">Trở lại </a>
