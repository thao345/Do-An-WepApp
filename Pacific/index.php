...
$sql = "SELECT id_tintuc,tieude, noidung, img, ngaytao FROM tintuc WHERE special='ok' ";
...
<body>
                ...
                foreach ($result as $items):
                    ...
                    <div class="testimonial-item p-4 my-5 team-item new mlr-20px service-item wow overflow-hidden"
                        ...
                        <div class="d-flex justify-content-center mb-4 " style="min-height: 170px;">
                            <img class="img-fluid flex-shrink-0 imgtieude" src="images/<?php echo $items['img']; ?>"
                        ...
                        <div style="height: 228px">
                            ...
                            <a class="btn-slide mt-2" href="viewsdetail.php?id_tintuc=<?php echo $items['id_tintuc'] ?>"><i class="fa fa-arrow-right"></i><span
    ...
    <div class="text-light" style="float: right;  border-top-left-radius: 10px; border-top-right-radius: 10px; background-color:gray" >
        <div class>
        <p class="" style="float: right; margin: 10px 10px 10px 10px;"><i class="fa-solid fa-eye"></i> Online: <span id="current_visitors"></span> </p>
        <p  class="" style="float: right; margin: 10px 10px 10px 10px;"><i class="fa-solid fa-globe"></i> Truy cập: <span id="total_visitors"></span></p>
        </div>
    </div>
    ...
    <div class="container-fluid bg-dark text-light footer pt-5 wow fadeIn" data-wow-delay="0.1s"
        style="margin-top: 41px;border-bottom-left-radius: 10px; border-bottom-right-radius: 10px;">
